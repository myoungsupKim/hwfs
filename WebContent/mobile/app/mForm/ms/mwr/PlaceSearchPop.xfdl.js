(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"clsfiCd\" type=\"STRING\" size=\"256\"/><Column id=\"detailCd\" type=\"STRING\" size=\"256\"/><Column id=\"clsfiNm\" type=\"STRING\" size=\"256\"/><Column id=\"detailNm\" type=\"STRING\" size=\"256\"/><Column id=\"remark1\" type=\"STRING\" size=\"256\"/><Column id=\"remark2\" type=\"STRING\" size=\"256\"/><Column id=\"remark3\" type=\"STRING\" size=\"256\"/><Column id=\"useYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Edit("edt_placeNm", "absolute", "132", "80", "173", "47", null, null, this);
            obj.set_taborder("71");
            obj.set_displaynulltext("장소명");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"131\"/><Column size=\"268\"/></Columns><Rows><Row size=\"0\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"Column0\"/><Cell col=\"1\"/><Cell row=\"1\" text=\"장소코드\"/><Cell row=\"1\" col=\"1\" text=\"장소명\"/></Band><Band id=\"body\"><Cell style=\"align:left middle;padding:0 10 0 10;\" text=\"bind:detailCd\"/><Cell col=\"1\" style=\"align:left;padding:0 10 0 10;\" text=\"bind:detailNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_placeCd", "absolute", "10", "80", "119", "47", null, null, this);
            obj.set_taborder("78");
            obj.set_displaynulltext("장소코드");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PlaceSearchPop.xfdl", "lib::lib_Com.xjs");
        this.registerScript("PlaceSearchPop.xfdl", function(exports) {
        //########################################################
        ...
        this.CmmnDeptSearchPop_onload = function(obj,e)
        {
        	...
        	this.edt_placeNm.set_value(this.arg[0]);
        ...
        *========================================================================*/
        ...
        {
        	var arg = new Array();
        	arg[0] = this.ds_grd.getColumn(e.row,"clsfiCd"); 	//분류코드
        	arg[1] = this.ds_grd.getColumn(e.row,"detailCd"); 	//장소코드
        	arg[2] = this.ds_grd.getColumn(e.row,"clsfiNm"); 	//분류명
        	arg[3] = this.ds_grd.getColumn(e.row,"detailNm"); 	//장소명
        	arg[4] = this.ds_grd.getColumn(e.row,"remark1"); 	//비고1
        	arg[5] = this.ds_grd.getColumn(e.row,"remark2"); 	//비고2
        	arg[6] = this.ds_grd.getColumn(e.row,"remark3"); 	//비고3
        	arg[7] = this.ds_grd.getColumn(e.row,"useYn"); 		//사용여부
        ...
        ********************************************************************************/
        ...
        {	
        	...
        	arrParam[0] = this.gfn_transNullToEmpty( "E001", "");	// E001:장소분류코드명
        	
        	var placeCd = this.gfn_transNullToEmpty(this.edt_placeCd.text);
        	var placeNm = this.gfn_transNullToEmpty(this.edt_placeNm.text);
        	
        	var strSvcID   		 = "placeSearchPop";
        	var strUrl     		 = "rc/bms/basCodeMgmt/selectCodeList.xdo";
        	var strInDataset     = "";
        	var strOutDataset    = "ds_grd=ds_codeList";
        	var strArguments	 = "clsfiCd=" +  arrParam[0] + " detailNm=" + placeNm;
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("PlaceSearchPop.xfdl", true);
