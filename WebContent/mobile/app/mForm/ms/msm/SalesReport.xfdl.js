    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("ProfitAndLossReport");
            ...
            obj._setContents("<ColumnInfo><Column id=\"upjang\" type=\"STRING\" size=\"256\"/><Column id=\"upjangnm\" type=\"STRING\" size=\"256\"/><Column id=\"spAmt\" type=\"STRING\" size=\"256\"/><Column id=\"ssAmt\" type=\"STRING\" size=\"256\"/><Column id=\"sdpRate\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"cd\" type=\"STRING\" size=\"256\"/><Column id=\"cdNm\" type=\"STRING\" size=\"256\"/><Column id=\"sortCol\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"cd\">01</Col><Col id=\"cdNm\">업장명</Col><Col id=\"sortCol\">upjangnm</Col></Row><Row><Col id=\"cd\">02</Col><Col id=\"cdNm\">계획</Col><Col id=\"sortCol\">spAmt</Col></Row><Row><Col id=\"cd\">03</Col><Col id=\"cdNm\">실적</Col><Col id=\"sortCol\">ssAmt</Col></Row><Row><Col id=\"cd\">04</Col><Col id=\"cdNm\">달성율</Col><Col id=\"sortCol\">sdpRate</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00", "absolute", null, "128", "120", "47", "-300", null, this);
            obj.set_taborder("15");
            obj.set_text("[단위천원]");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"161\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"100\"/></Columns><Rows><Row size=\"55\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"업장명\"/><Cell col=\"1\" text=\"계획\"/><Cell col=\"2\" text=\"실적\"/><Cell col=\"3\" text=\"달성률\"/></Band><Band id=\"body\"><Cell style=\"align:left middle;padding:0 5 0 5;\" text=\"bind:upjangnm\" wordwrap=\"char\" autosizerow=\"limitmin\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right middle;padding:0 5 0 5;color:EXPR(spAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);color2:EXPR(spAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);selectcolor:EXPR(spAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);\" text=\"bind:spAmt\" wordwrap=\"char\" mask=\"#,##0\" autosizerow=\"limitmin\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right middle;padding:0 5 0 5;color:EXPR(ssAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);color2:EXPR(ssAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);selectcolor:EXPR(ssAmt &lt; 0 ?&quot;red&quot;:&quot;&quot;);\" text=\"bind:ssAmt\" wordwrap=\"char\" mask=\"#,##0\" autosizerow=\"limitmin\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right middle;padding:0 5 0 5;\" text=\"bind:sdpRate\" wordwrap=\"char\" mask=\"#,##0.0\" autosizerow=\"limitmin\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SalesReport.xfdl", "lib::lib_Com.xjs");
        this.registerScript("SalesReport.xfdl", function(exports) {
        //########################################################
        ...
        ********************************************************************************/
        ...
        this.fn_search = function()
        {
        	...
        	var strSvcID   		 = "search";
        	var strUrl     		 = "ms/msm/salesReport/selectList.xdo";
        	var strInDataset     = "";
        ...
        ********************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.Button17.addEventHandler("onclick", this.btn_upSort_onclick, this);
            this.Button15.addEventHandler("onclick", this.btn_downSort_onclick, this);
        ...
        this.loadIncludeScript("SalesReport.xfdl", true);
