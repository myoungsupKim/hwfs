    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FoodMaterialsSabunPop");
                this.set_titletext("담당자 검색");
            ...
            obj._setContents("<ColumnInfo><Column id=\"sabun\" type=\"STRING\" size=\"256\"/><Column id=\"nmKor\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"161\"/><Column size=\"199\"/></Columns><Rows><Row size=\"0\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"Column0\"/><Cell col=\"2\"/><Cell row=\"1\"/><Cell row=\"1\" col=\"1\" text=\"사원번호\"/><Cell row=\"1\" col=\"2\" text=\"성명\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\"/><Cell col=\"1\" style=\"align:left middle;padding:0 10 0 10;\" text=\"bind:sabun\" wordwrap=\"char\" autosizerow=\"limitmin\"/><Cell col=\"2\" style=\"align:left;padding:0 10 0 10;\" text=\"bind:nmKor\" wordwrap=\"char\" autosizerow=\"limitmin\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("FoodMaterialsSabunPop.xfdl", "lib::lib_Com.xjs");
        this.registerScript("FoodMaterialsSabunPop.xfdl", function(exports) {
        //########################################################
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//this.ds_search.setColumn(nRow, "schCode", "");	//사원번호
        	//this.ds_search.setColumn(nRow, "schName", "");	//사원명
        	
        	//this.edt_deptNm.set_value(this.arg[0]);
        	this.muCd = this.arg[0];
        ...
        ********************************************************************************/
        ...
        {	
        	...
        	//this.ds_search.setColumn(0, "schCode", this.edt_sabun.value);	//사원번호
        	//this.ds_search.setColumn(0, "schName", this.edt_nmKor.value);	//사원명
        	...
        	var strUrl     		 = "ms/msm/deptSearchPop/selectSabunList.xdo";
        	var strInDataset     = "";
        	...
        	var strArguments	 = "schCode=" + nexacro.wrapQuote(schCode);
        	    ...
        	    strArguments     += " schMuCd=" + nexacro.wrapQuote(this.muCd);
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("FoodMaterialsSabunPop.xfdl", true);
