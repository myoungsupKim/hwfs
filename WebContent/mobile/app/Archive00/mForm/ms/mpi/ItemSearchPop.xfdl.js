(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"itemCd\" type=\"STRING\" size=\"256\"/><Column id=\"itemNm\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"itemCd\">00000001</Col><Col id=\"itemNm\">단팥죽(동원)</Col></Row><Row><Col id=\"itemCd\">00000002</Col><Col id=\"itemNm\">맛이좋은일품짜장분말(에스비)</Col></Row><Row><Col id=\"itemCd\">00000003</Col><Col id=\"itemNm\">오랜지푸딩(나스팍)</Col></Row><Row><Col id=\"itemCd\">00000004</Col><Col id=\"itemNm\">딸기푸딩(나스팍)</Col></Row><Row><Col id=\"itemCd\">00000005</Col><Col id=\"itemNm\">야채죽(동원)</Col></Row><Row><Col id=\"itemCd\">00000006</Col><Col id=\"itemNm\">삼계탕(하우스)/파우치</Col></Row></Rows>");
            ...
            obj = new Edit("edt_itemNm", "absolute", "132", "80", "173", "47", null, null, this);
            obj.set_taborder("71");
            obj.set_displaynulltext("품목명");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"131\"/><Column size=\"268\"/></Columns><Rows><Row size=\"0\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"Column0\"/><Cell col=\"1\"/><Cell row=\"1\" text=\"품목코드\"/><Cell row=\"1\" col=\"1\" text=\"품목명\"/></Band><Band id=\"body\"><Cell style=\"align:left middle;padding:0 10 0 10;\" text=\"bind:itemCd\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:itemNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_itemCd", "absolute", "10", "80", "119", "47", null, null, this);
            obj.set_taborder("78");
            obj.set_displaynulltext("품목코드");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ItemSearchPop.xfdl", "lib::sz_fsp_xp.xjs");
        this.registerScript("ItemSearchPop.xfdl", function(exports) {
        //########################################################
        ...
        this.CmmnDeptSearchPop_onload = function(obj,e)
        {
        	...
        	this.edt_itemNm.set_value(this.arg[0]);
        ...
        *========================================================================*/
        ...
        {
        	var arg = new Array();
        	arg[0] = this.ds_grd.getColumn(e.row,"itemCd"); 	//업장코드
        	arg[1] = this.ds_grd.getColumn(e.row,"itemNm"); 	//업장명
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("ItemSearchPop.xfdl", true);
