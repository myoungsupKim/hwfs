    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("CustMgmtSearchPop");
                this.set_titletext("담당자및가망고객검색");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"schCond\" type=\"STRING\" size=\"256\"/><Column id=\"schCode\" type=\"STRING\" size=\"256\"/><Column id=\"schName\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"schCode\"/><Col id=\"schName\"/><Col id=\"schCond\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_custNm", "absolute", "132", "80", "173", "47", null, null, this);
            obj.set_taborder("71");
            obj.set_displaynulltext("고객명");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"185\"/><Column size=\"215\"/></Columns><Rows><Row size=\"0\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"Column0\"/><Cell col=\"1\"/><Cell row=\"1\" text=\"담당자명\"/><Cell row=\"1\" col=\"1\" text=\"고객명\"/></Band><Band id=\"body\"><Cell style=\"align:left middle;padding:0 10 0 10;\" text=\"bind:mgmtSabunnm\" wordwrap=\"char\" autosizerow=\"limitmin\"/><Cell col=\"1\" style=\"align:left;padding:0 10 0 10;\" text=\"bind:custnm\" wordwrap=\"char\" autosizerow=\"limitmin\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_mgmtNm", "absolute", "10", "80", "119", "47", null, null, this);
            obj.set_taborder("78");
        ...
        // User Script
        this.addIncludeScript("CustMgmtSearchPop.xfdl", "lib::lib_Com.xjs");
        this.registerScript("CustMgmtSearchPop.xfdl", function(exports) {
        //########################################################
        // [프로젝트]		FC종합전산 모바일시스템 구축
        // [시스템명]		담당자및가망고객 검색
        // [부시스템명]	담당자및가망고객 검색 - 조회
        // [설명]
        // 		부서 검색하기.
        // [작성자명] 		강대성
        // [작성일자]		2015.05.19
        ...
        *========================================================================*/
        ...
        {
        	var arg = new Array();
        	arg[0] = this.ds_grd.getColumn(e.row,"custnm"); 	    //고객명
        	arg[1] = this.ds_grd.getColumn(e.row,"ccNm"); 	        //부서명
        	arg[2] = this.ds_grd.getColumn(e.row,"mgmtSabun"); 	    //담당자사번
        	arg[3] = this.ds_grd.getColumn(e.row,"mgmtSabunnm"); 	//담당자명
        	arg[4] = this.ds_grd.getColumn(e.row,"name"); 	        //고객담당자명
        	arg[5] = this.ds_grd.getColumn(e.row,"hpTel"); 	        //고객연락처
        	arg[6] = this.ds_grd.getColumn(e.row,"addr"); 	        //고객주소
        	arg[7] = this.ds_grd.getColumn(e.row,"jobCdnm"); 	    //직군1
        	arg[8] = this.ds_grd.getColumn(e.row,"locCdnm");     	//지역1
        ...
        ********************************************************************************/
        ...
        {	
        	...
        	var mgmtSabunNm = this.gfn_transNullToEmpty(this.edt_mgmtNm.text);	//담당자명
        	var custNm = this.gfn_transNullToEmpty(this.edt_custNm.text);	//고객명
        	
        	
        	var strSvcID   		 = "searchSabun";
        	var strUrl     		 = "ms/msm/customerInformationInquiry/selectCustList.xdo";
        	var strInDataset     = "";
        	var strOutDataset    = "ds_grdServer=ds_list";
        	var strArguments	 = "mgmtSabunNm=" + nexacro.wrapQuote(mgmtSabunNm);
        	    strArguments     += " custNm=" + nexacro.wrapQuote(custNm);
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("CustMgmtSearchPop.xfdl", true);
