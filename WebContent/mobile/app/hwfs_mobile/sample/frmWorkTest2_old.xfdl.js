(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("Edit00", "absolute", "16", "62", "180", "33", null, null, this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);

            obj = new Button("Button01", "absolute", "224", "60", "178", "41", null, null, this);
            obj.set_taborder("6");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"29\"/><Column size=\"62\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"Column0\"/><Cell col=\"1\" text=\"Column1\"/><Cell col=\"2\" text=\"Column2\"/><Cell col=\"3\" text=\"Column3\"/><Cell col=\"4\" text=\"Column4\"/><Cell col=\"5\" text=\"Column5\"/><Cell col=\"6\"/></Band><Band id=\"body\"><Cell style=\"align:center;\" text=\"bind:Column0\" suppress=\"1\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:Column1\"/><Cell col=\"2\" style=\"align: ;\" text=\"bind:Column2\"/><Cell col=\"3\" style=\"align:center;\" text=\"bind:Column3\"/><Cell col=\"4\" style=\"align:center;\" text=\"bind:Column4\"/><Cell col=\"5\" style=\"align:center;\" text=\"bind:Column5\"/><Cell col=\"6\" edittype=\"text\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button02", "absolute", "410", "24", "142", "50", null, null, this);
            obj.set_taborder("11");
            obj.set_text("openPOP");
            this.addChild(obj.name, obj);

            obj = new Edit("edtYM", "absolute", "19", "8", "205", "48", null, null, this);
            obj.set_taborder("12");
            this.addChild(obj.name, obj);

            obj = new Button("btnPop", "absolute", "237", "8", "103", "47", null, null, this);
            obj.set_taborder("13");
            obj.set_text("년월");
            this.addChild(obj.name, obj);

            obj = new Calendar("Calendar00", "absolute", "28", "606", "156", "50", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("14");
        ...
        // User Script
        this.addIncludeScript("frmWorkTest2_old.xfdl", "lib::sz_fsp_xp.xjs");
        this.registerScript("frmWorkTest2_old.xfdl", function(exports) {
        ...
        //	trace("테스트 업무화면");
        	this.parent.btnGoTop.bringToFront();

        	//application.goMain.gfn_goTop();
        }
        ...
        ********************************************************************************/
        ...
        this.Button02_onclick = function(obj,e)
        {
        	...
        	application.goMain.gfn_POP_create("PopCalMonth", "cmmn::CmmnCalMonthPop.xfdl", "fn_callbackPOP", this, objCalArg, "POPx", application.goMain.divBase);
        	return false;
        }
        ...
        this.Calendar00_ondropdown = function(obj,e)
        {
        	...
        	arg[2] = "";
        	arg[3] = "year";
        	application.goMain.gfn_POP_create("Year", "cmmn::CmmnCalendarTest.xfdl", "fn_callbackPOP", this, "", "POP", application.goMain.divBase);
        	return false;
        }

        this.frmExam_001_onslide = function(obj,e)
        {
        //	trace("e.yaccvalue :: "+e.yaccvalue);
        //	trace("e.ydeltavalue :: "+e.ydeltavalue);
        ...
        this.on_initEvent = function()
        {
            ...
            this.Calendar00.addEventHandler("ondropdown", this.Calendar00_ondropdown, this);

        };

        this.loadIncludeScript("frmWorkTest2_old.xfdl", true);
