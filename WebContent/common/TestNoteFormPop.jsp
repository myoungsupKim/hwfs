...
<%
   ...
   * 시험양식조회
   * - 서버 scriptlet 이용 (비표준)
   * @ClassName TestNoteFormPop.jsp
   * @Description TestNoteFormPop JSP
...
<%
    ...
    String strReqNum    = LimsUtil.checkNull(request.getParameter("REQNUM"));
    String strSpecmCd    = LimsUtil.checkNull(request.getParameter("SPECMCD"));
    String strAcceptNum     = LimsUtil.checkNull(request.getParameter("ACCEPTNUM"));
    String strArticleCd = LimsUtil.checkNull(request.getParameter("ARTICLECD"));
    String strFormCd   = LimsUtil.checkNull(request.getParameter("FORMCD"));
