...
boolean canAccess = true; //FICS는 외부망 접근가능
%>
 ...
 */
var strKey  = "FICS";				    //key
var strADL = "FICS.xadl";	 		//ADL
var strShortCut = "FICS";				//Shortcut Name
		...
		<tr>
			<td background="./img/system_bg.jpg" style="padding:100px 45px 10px 45px">
				<table width="100%" style="font-family:dotum;font-size:12px;font-color:#444444;">				
					...
					<tr>
						<td align="center">
							<button type="button" class="button" style="vertical-align:middle">FICS 설치프로그램</button>
						</td>
						<td align="center">
							<a id="linkAll" class="button2" style="background-color:#f97878;" href="./installation/Setup_FICS.exe">설치</a>
						</td>
					</tr>
					<tr>
						<td colspan="2" height="10px"></td>
