...
<body onload="onLoad()" leftmargin=0 topmargin=0 scroll=no>
	<div id = "InstallOZViewer">
	    <object id = "ZTransferX" classid = "CLSID:C7C7225A-9476-47AC-B0B0-FF3B79D55E67" width = "0" height = "0" codebase = "<%=propertiesService.getString("oz.download.ztransferx.server")%>ZTransferX.cab#version=2,2,5,1">
