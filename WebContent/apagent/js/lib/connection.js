 ...
 */
/** 
 * @fileoverview XmlHttpRequest와 같은 동작을 하는 클래스
 *
...
/**
 * PostConnection 객체 생성자
 * @class Ajax 사용되는 클래스 
 * <br>XmlHttpRequest가 form을 사용할 수 없는 반면 PostConnection에서는 form 사용 가능함
 * @constructor
 * @return A new PostConnection
 * @author 박성수 <a href="mailto:ghbpark@hanwha.co.kr">ghbpark@hanwha.co.kr</a>
 * @version 2.0 
 */
hanwha.commons.PostConnection = function PostConnection(ecName) {
	this.name = ecName;
...
hanwha.commons.PostConnection.prototype = {
