...
<%
	...
	try{
	    companyPath = apAgentParam.getParameter("agentCompanyId");
	} catch (Exception e) {
	}
...
%>
	...
	document.f.slo_p_ota.value = '<%=apAgentParam.getParameter("slo_p_ota")%>';

	document.f.action = "https://"+approvalHost+"/neo/modules/approval/apagent/channel/v4/popup_view_" + agentCompanyAlias + ".mvc";
...
<input type="hidden" name="slo_p_ota" value="">
