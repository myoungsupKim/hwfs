...
<%
	try	{
		...
		sbSql.append( "      , A.UNIT_PRICE, A.SALE_PRICE, A.ORIGIN_TYPE \n");
		...
		sbSql.append( "             , A.CONTRACT_PRICE AS UNIT_PRICE, A.SALE_PRICE, B.ORIGIN_TYPE \n");
		...
		sbSql.append( "             , B.USE_YN \n");
		sbSql.append( "             , A.UNIT_PRICE, A.SALE_PRICE, B.ORIGIN_TYPE \n");
