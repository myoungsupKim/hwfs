...
<%
	...
	try	{
		...
		String DT_FR		  =	nullToBlank(ds_item_condi.getString(0, "DT_FR"));
		String DT_TO		  =	nullToBlank(ds_item_condi.getString(0, "DT_TO"));
...
// [속도개선 Project 시작] 2017. 8. 28. 최범주
		...
		//2016.05.12 최학진 외식 외식 사업기획팀 메뉴 R&D 이다미 요청 최근 DATA 조회시 최근 날짜 조회 되게 해달라는 요청
		sbSelSql.append("	  ,	A.RECENT_NEED_DATE    											 /* 최근 입고일자 */																										\n");
		sbSelSql.append("  FROM	(																																												\n");
		//2016.05.12 최학진 외식 외식 사업기획팀 메뉴 R&D 이다미 요청 최근 DATA 조회시 최근 날짜 조회 되게 해달라는 요청
		//sbSelSql.append("		 SELECT	 DISTINCT																		
		sbSelSql.append("		 SELECT	 																																								\n");
		sbSelSql.append("				 C.ITEM_CODE																																							\n");
		...
		//2016.05.12 최학진 외식 외식 사업기획팀 메뉴 R&D 이다미 요청 최근 DATA 조회시 최근 날짜 조회 되게 해달라는 요청
		sbSelSql.append("	           , MAX(F.NEED_DATE) AS RECENT_NEED_DATE																																		\n");
		...
		sbSelSql.append("			 AND F.ITEM_CODE	= A.ITEM_CODE																																			\n");
		sbSelSql.append("			 AND F.RC_UPJANG	= A.UPJANG																																				\n");
		sbSelSql.append("			 AND F.CUSTCD		= A.CUSTCD																																				\n");
		sbSelSql.append("			 AND F.SUBINV_CODE	= B.SUBINV_CODE																																			\n");
		sbSelSql.append("			 AND F.NEED_DATE BETWEEN '"	+ DT_FR	+ "' AND '"	+ DT_TO	+ "'																												\n");
		//2016.05.12 최학진 최근 날짜 추가 시작
		sbSelSql.append("			GROUP BY 	 C.ITEM_CODE																																		\n");					
		sbSelSql.append("						   , C.ITEM_NAME																																	\n");						
		sbSelSql.append("						   , C.ITEM_CLASS4																																	\n");						
		sbSelSql.append("						   , C.ITEM_SIZE																																	\n");						
		sbSelSql.append("						   , C.PO_UOM																																		\n");						
		sbSelSql.append("						   , C.TAX_CODE																																		\n");						
		sbSelSql.append("						   , A.PROC_TYP_CD                                                                                                                                  \n");
		sbSelSql.append("						   , C.POINT_FLAG																																	\n");						
		sbSelSql.append("						   , B.UPJANG																																		\n");						
		sbSelSql.append("						   , B.INVAT_FLAG																																	\n");						
		sbSelSql.append("						   , B.OUTVAT_FLAG																																	\n");						
		...
		sbSelSql.append("						   , C.MULTIPLIER_QTY																																\n");						
		sbSelSql.append("						   , C.USE_YN																																		\n");						
		sbSelSql.append("						   , TO_NUMBER(DECODE(A.MARGIN_RATE, 0, A.CONTRACT_PRICE,	(ROUND((A.CONTRACT_PRICE + (A.CONTRACT_PRICE * A.MARGIN_RATE / 100)) / 10) * 10)))      \n");
		sbSelSql.append("						   , A.CONTRACT_PRICE /* 구매(매입)단가	*/																											\n");	
		sbSelSql.append("						   , A.CUSTCD			/* 매입거래처코드 */																											\n");								   
		sbSelSql.append("						   , NVL(C.KG_CONVERT_RATE,	1)                                                                                                                      \n");
		sbSelSql.append("						   , A.MARGIN_RATE																																	\n");						
		...
		sbSelSql.append("						   , C.ORIGIN_NAT																																	\n");						
		sbSelSql.append("						   , C.ORIGIN_TYPE																																	\n");						
		sbSelSql.append("						   , B.MATERIAL_ACCTCD                                                                                                                              \n");
		sbSelSql.append("						   , B.BUDCC_CD                                                                                                                                     \n");
		sbSelSql.append("						   , A.DUTY_YN																																		\n");						
		sbSelSql.append("						   , A.PB_YN																																		\n");						
		sbSelSql.append("						   , C.MANUF_CD 																																	\n");						
		sbSelSql.append("						   , C.ECO_ITEM																																		\n");						
