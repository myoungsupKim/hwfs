...
<%
	try
	{
		...
		sbSql.append("     , CASE WHEN E.TAX_CODE = '100' \n");
		...
		sbSql.append("   AND B.CLASS_CODE = E.ITEM_CLASS2 \n");
		sbSql.append("   AND C.CLASS_CODE = E.ITEM_CLASS3 \n");
		sbSql.append("   AND D.CLASS_CODE = E.ITEM_CLASS4 \n");
		...
		if( !CLASS3.equals("") )
		{
			sbSql.append("   AND E.ITEM_CLASS3 = '" + CLASS3 + "' -- 중분류선택시 \n");
		}
		sbSql.append("   AND E.ITEM_CLASS1 = '" + ITEMGBN +  "' -- 분류선택시 \n");
		sbSql.append("   AND Z.CANCEL_YN = 'N' \n");
		if( !SUBINV.equals("") )
		{
			sbSql.append("GROUP BY A.PHYSIC_DATE, A.SUBINV_CODE, B.CLASS_CODE, C.CLASS_CODE, D.CLASS_CODE, B.CLASS_NAME, C.CLASS_NAME, D.CLASS_NAME, E.TAX_CODE \n");
			...
			sbSql.append("ORDER BY A.PHYSIC_DATE, B.CLASS_CODE, C.CLASS_CODE, D.CLASS_CODE \n");
