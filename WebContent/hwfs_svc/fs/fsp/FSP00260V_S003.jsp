...
<%
	try	{
		...
		sbSql.append("     , VO_FC_VENDOR D \n");
		sbSql.append(" WHERE A.RC_UPJANG = B.UPJANG \n");
		sbSql.append("   AND A.CUSTCD    = TO_CHAR(D.VD_CD) \n");
		sbSql.append("GROUP BY NEED_DATE, VD_NM, ITEM_CODE, ITEM_NAME, ITEM_SIZE, PO_UOM, TAX, MARGIN_PRICE \n");

		pstmt = conn.prepareStatement(sbSql.toString());
		rs = pstmt.executeQuery();
		DataSet ds_list3 = this.makeDataSet(rs, "ds_list");
