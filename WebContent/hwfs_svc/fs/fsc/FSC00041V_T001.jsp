    ...
    try {
        ...
        */
        ...
        if (strTmCD.length() != 0)
        	...
        	sbSql.append("           AND TM_CD IN ('" + strTmCD + "',SUBSTR('" + strTmCD + "',0,3)) \n");
        ...
        sbSql.append("             , 0 SCORE0 \n");
        sbSql.append("             , 0 SCORE1 \n");
        sbSql.append("             , SCORE AS SCORE2 \n");
        sbSql.append("             , 0 SCORE3 \n");
        sbSql.append("             , 0 SCORE4 \n");
        sbSql.append("             , NOT_FIT_YN NOT_FIT \n");
        sbSql.append("             , 0 NOT_FIT0 \n");
        sbSql.append("             , 0 NOT_FIT1 \n");
        sbSql.append("             , NOT_FIT_YN  NOT_FIT2 \n");
        sbSql.append("             , 0 NOT_FIT3 \n");
        sbSql.append("             , 0 NOT_FIT4 \n");
        sbSql.append("             , 0 CNT0 \n");
        sbSql.append("             , 0 CNT1 \n");
        ...
        // 년도조회에서 기간조회로 변경
        //============================================================================================
        //sbSql.append("           AND SUBSTR(CHECK_DATE,1,6) BETWEEN '" + strYear + "04' AND '" + strYear + "06' \n");
        sbSql.append("           AND CHECK_DATE BETWEEN SUBSTR('" + strFromDate + "',1,4)||'0401' AND SUBSTR('"
                + strToDate + "',1,4)||'0631' \n");
        //============================================================================================
        //(2012-10-22 수정) 끝
        //============================================================================================
        ...
        sbSql.append("             , 0 SCORE1 \n");
        sbSql.append("             , 0 SCORE2 \n");
        sbSql.append("             , SCORE AS SCORE3 \n");
        sbSql.append("             , 0 SCORE4 \n");
        sbSql.append("             , NOT_FIT_YN NOT_FIT \n");
        sbSql.append("             , 0 NOT_FIT0 \n");
        sbSql.append("             , 0 NOT_FIT1 \n");
        sbSql.append("             , 0 NOT_FIT2 \n");
        sbSql.append("             , NOT_FIT_YN NOT_FIT3 \n");
        sbSql.append("             , 0 NOT_FIT4 \n");
        sbSql.append("             , 0 CNT0 \n");
        sbSql.append("             , 0 CNT1 \n");
        sbSql.append("             , 0 CNT2 \n");
        ...
        // 년도조회에서 기간조회로 변경
        //============================================================================================
        //sbSql.append("           AND SUBSTR(CHECK_DATE,1,6) BETWEEN '" + strYear + "07' AND '" + strYear + "09' \n");
        ...
        sbSql.append("           AND CHECK_DATE BETWEEN SUBSTR('" + strFromDate + "',1,4)||'1001' AND SUBSTR('"
                + strToDate + "',1,4)||'1231' \n");
        //============================================================================================
        //(2012-10-22 수정) 끝
        //============================================================================================
        ...
        sbSql.append("ORDER BY 1, TM_CD, TEAM_MST_SABUN, SUBTEAM_MST_SABUN  \n");
