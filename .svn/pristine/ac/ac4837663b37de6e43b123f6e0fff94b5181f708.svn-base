 ...
 * </pre>
 */
public class AppMasterInterface52Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterface52Tasklet stepExecutionId : " + stepExecutionId);
        ...
        param.put("FROM_UPJANG_CD", "195000");
        param.put("TO_UPJANG_CD", "195999");
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface52Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface52Step", "OK", strRtnMsg);
