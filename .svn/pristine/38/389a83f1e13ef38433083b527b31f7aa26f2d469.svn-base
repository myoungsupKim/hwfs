...
//-----------------------------------------------------------------------------
//  ■ 시스템명     : 식재영업/보조금 내역 조회
//  ■ 프로그램ID   : FMP00930V_T001.jsp
//  ■ 프로그램명   : 친환경 자재 정부 보조금 내역 조회
//  ■ 작성일자     : 2010.08.17
//  ■ 작성자       : 노규완
//■ 이력관리     : 2010.08.17
...
<%
	...
	//FileLog.println("d:\\aaa.txt", ds_cond);
        ...
        sbSql.append("      ,NVL(A.SUB_AMOUNT,0) AS SUB_AMOUNT                                                                                                          \n");
        sbSql.append("      ,SUM(A.SALE_PRICE) AS SALE_PRICE                                                                                                            \n");
        sbSql.append("      ,SUM(A.GREEN_AMT) AS GREEN_AMT                                                                                                              \n");
        sbSql.append("      , SUM(A.SALE_PRICE) - SUM(A.GREEN_AMT) AS UPJANG_PRICE                                                                                      \n");
        ...
        sbSql.append("      ,NVL(A.QTY * A.PRICE,0) AS SALE_PRICE                                                                                                       \n");
        sbSql.append("      ,NVL(A.GREEN_AMT,0) AS GREEN_AMT                                                                                                            \n");
        ...
        sbSql.append("   ) A                                                                                                                                            \n");
        sbSql.append("GROUP BY A.UPJANG,A.UPJANGNM_DISP,A.NEED_DATE,NVL(A.SUB_AMOUNT,0)                                                                                 \n");		
