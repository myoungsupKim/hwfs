...
<%
	...
	try
	{
		...
		sbSql.append("     , SUM(M_REAL_QTY)   AS PHYSIC_QTY -- 실사량 \n");
		...
		sbSql.append("  GROUP BY TRANS_DATE, SUBINV_NAME, L_CLASS_CODE, L_CLASS_NAME, TAX_CODE \n");
		sbSql.append("  ORDER BY TRANS_DATE, L_CLASS_CODE \n");
