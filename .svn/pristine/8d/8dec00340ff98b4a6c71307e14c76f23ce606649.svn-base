...
import java.util.Map;
 ...
 /**
 * 후불 결제 내역 관리하는 ArSettleDescMgnt Service Interface
 * 
 * @ClassName ArSettleDescMgntService.java
 * @Description ArSettleDescMgntService Class
 ...
 * </pre>
 */
public interface ArSettleDescMgntService {
