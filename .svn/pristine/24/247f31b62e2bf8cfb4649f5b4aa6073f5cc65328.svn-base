...
<%
	...
	try {
		...
		String IMPROV_CONFIRM_YN = nullToBlank(ds_resultMst.getString(0, "IMPROV_CONFIRM_YN"));
		
		sbSql.delete(0, sbSql.length());
		sbSql.append("UPDATE FSC_CONTRT_RESULT                                \n");
		sbSql.append("   SET IMPROV_CONFIRM_YN = '" + IMPROV_CONFIRM_YN + "'  \n"); 
