...
import java.util.Map;
 ...
 /**
 * 영업유형을 관리하는 SalesTypeMgnt Service Interface
 * 
 * @ClassName SalesTypeMgntService.java
 * @Description SalesTypeMgntService Class
 ...
 * </pre>
 */
public interface SalesTypeMgntService {
