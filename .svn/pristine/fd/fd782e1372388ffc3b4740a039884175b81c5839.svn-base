...
<%
	try	{
		...
		sbSql.append("SELECT A.UPJANG, A.HALL_CODE                                                                                                                    \n");
    	...
    	sbSql.append("   AND B.ITEM_CODE = '" + strITEM + "'																											\n");        
        ...
        sbSql.append(" GROUP BY A.UPJANG, A.HALL_CODE, A.TRANS_DATE                                                                                                   	\n");
        sbSql.append(" ORDER BY A.HALL_CODE, TRANS_DATE                                                                                                               	\n");
