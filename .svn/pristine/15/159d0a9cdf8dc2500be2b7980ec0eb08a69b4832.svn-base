...
/**
 * 식재앱 업장자재3개월주문금액 송신 배치Scheduler Job Class
 * @ClassName AppUpjangSaleamtInterfaceTasklet.java
 * @Description AppUpjangSaleamtInterfaceTasklet Class
 ...
 * </pre>
 */
public class AppUpjangSaleamtInterfaceTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        procCnt = appMasterInterfaceDAO.batchJob5(param);
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppUpjangSaleamtInterfaceStep", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppUpjangSaleamtInterfaceStep", "OK", strRtnMsg);
