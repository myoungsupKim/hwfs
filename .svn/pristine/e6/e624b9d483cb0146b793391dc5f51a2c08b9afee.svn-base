package com.hwfs.batch.sc.scc.service;
...
import com.hwfs.sc.scc.dao.HnrFicsOrderInterfaceSqlDAO;
 ...
 /**
 * HnrFicsOrderInterfaceServiceImpl에 대한 설명 작성
 * @ClassName HnrFicsOrderInterfaceServiceImpl.java
 * @Description HnrFicsOrderInterfaceServiceImpl Class 
 ...
 * </pre>
 */
@Service("/batch/sc/scc/hnrFicsOrderInterfaceService")
public class HnrFicsOrderInterfaceServiceImpl extends DefaultServiceImpl implements HnrFicsOrderInterfaceService {
    ...
    public int batchJobSuspense() throws Exception {
		...
		try {
			...
			// 인터페이스 대상 발주정보 조회
			//batchOrderListRs = super.queryForRecordSet("sc.scc.HnrFicsOrderInterfaceSqlDAO.selectBatchOrderList", param);
			batchOrderListRs = hnrFicsOrderInterfaceSqlDAO.selectBatchOrderList(new HashMap<String, Object>());
