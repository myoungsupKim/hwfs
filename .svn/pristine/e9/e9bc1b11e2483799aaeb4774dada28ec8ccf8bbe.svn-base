...
import com.hwfs.sc.cmn.sap.dto.SalsMmSumDTO;
import com.tobesoft.xplatform.data.DataSet;

/**
 * SalsMmSumList에 대한 설명 작성
 *
 * @ClassName SalsMmSumList.java
 * @Description SalsMmSumList Class
 ...
 * </pre>
 */
public class SalsMmSumList implements EAIList {
	public List<SalsMmSumDTO> dataList = new ArrayList<SalsMmSumDTO>();
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteSalsMmSum";
	}
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertSalsMmSum";
	}
	...
	public void setDataList(List<?> list) {
		dataList = (List<SalsMmSumDTO>) list;
	}
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, SalsMmSumDTO.class);
	}
	...
	public void setDataList(DataSetMap dsm) {
		for (int i = 0; i < dsm.getRowMaps().size(); i++) {
			SalsMmSumDTO dto = new SalsMmSumDTO();
			dto = (SalsMmSumDTO) DTOUtil.convertMapToVo(
					dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for (int i = 0; i < maps.size(); i++) {
			SalsMmSumDTO dto = new SalsMmSumDTO();
			dto = (SalsMmSumDTO) DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
