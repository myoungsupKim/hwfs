 ...
 */
    ...
    sbSql.append("     , (SELECT MAX(SC_NM) FROM HLDC_SC_SC Z WHERE SUBSTR(A.TM_CD,1,3) = Z.SC_CD)||'/'||(SELECT MAX(TM_NM) FROM HLDC_SC_DEPT_V WHERE A.TM_CD = TM_CD) AS TM_NM                                                   \n");
    ...
    sbSql.append("     , DECODE(A.NOT_FIT_YN, 0, '합격', '불합격') AS NOT_FIT                                                                         \n");
    sbSql.append("     , A.THEME_MGMT                                                                                                                 \n");
    ...
    sbSql1.append("     , C.SVR_IMGE AS SVR_IMGE                                                         \n");
	sbSql1.append("     , C.IMPROV_SVR_IMGE  AS IMPROV_SVR_IMGE                                          \n");
    sbSql1.append("  FROM FSC_FORM_DTL A                                                                 \n");
    sbSql1.append("     , FSC_RESULT_DTL B                                                               \n");
    sbSql1.append("     , FSC_CHK_IMGE C                                                                 \n");
    ...
    sbSql1.append("   AND B.TABLE_TYPE = C.TABLE_TYPE(+)                                                 \n");
    sbSql1.append("   AND B.FORM_CD = C.FORM_CD(+)                                                       \n");
    sbSql1.append("   AND B.UPJANG = C.UPJANG(+)                                                         \n");
    sbSql1.append("   AND B.CLASS_CD = C.CLASS_CD(+)                                                     \n");
    sbSql1.append("   AND B.CHECK_DATE = C.CHK_DD(+)                                                     \n");
    ...
    sbSql2.append("     , TO_CHAR(TO_DATE(A.CHECK_DATE, 'YYYYMMDD'), 'YYYY-MM-DD') AS CHECK_DATE          \n");
    sbSql2.append("     , TO_CHAR(TO_DATE(A.MGMT_DATE, 'YYYYMMDD'), 'YYYY-MM-DD') AS MGMT_DATE            \n");
    sbSql2.append("     , B.SVR_IMGE                                                                      \n");
    sbSql2.append("     , B.IMPROV_SVR_IMGE                                                               \n");
    sbSql2.append("     , A.IMPROV_MGMT                                                                   \n");
    sbSql2.append("  FROM FSC_RESULT_DTL A                                                                \n");
    sbSql2.append("     , FSC_CHK_IMGE B                                                                  \n");
    sbSql2.append("     , FSC_FORM_DTL C                                                                  \n");
    ...
    sbSql2.append("   AND (A.MAX_YN = 'N' OR (C.NOT_FIT_YN = 'Y' AND NVL(A.INDICATE_CNT,0) > 0))          \n");
...
<DIV id=subContents>
    <DIV class=contents>
        <DIV style="TEXT-ALIGN: center; margin-top:20px;">
            <SPAN STYLE="font-size:20px;"><b>[<%=nullToBlank(rs.getString("CHECK_TYPE_NM"))%>] <%=nullToBlank(rs.getString("UPJANGNM"))%> - 개선 조치 보고서</b></SPAN>
        </DIV>
        ...
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    <TR>
                        <TH style="TEXT-ALIGN: center">소  속</TH>
                    ...
                    <TR>
                        ...
                        <TH style="TEXT-ALIGN: center">불합격판정</TH>
        ...
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    ...
                    %>
                    <TR>
                        <TD style="TEXT-ALIGN: center; HEIGHT:120px"><%=nullToBlank(rs1.getString("LRG_CLASS_NAME"))%></TD>
                        <TD style="TEXT-ALIGN: center; HEIGHT:120px"><%=nullToBlank(rs1.getString("MIDDLE_CLASS_NAME"))%></TD>
                        <TD style="TEXT-ALIGN: left; HEIGHT:120px"><%=nullToBlank(rs1.getString("CLASS_NAME"))%></TD>
                        <TD style="TEXT-ALIGN: left; HEIGHT:120px"><%=nullToBlank(rs1.getString("EVAL_CONTENTS"))%></TD>
                        <TD style="TEXT-ALIGN: left; HEIGHT:120px"><%=nullToBlank(rs1.getString("IMPROV_MGMT"))%></TD>
                        <TD style="TEXT-ALIGN: center; HEIGHT:120px"><%=nullToBlank(rs1.getString("MGMT_DATE"))%></TD>
                        ...
                        <%
                    			...
                    			if(rs1.getString("SVR_IMGE").indexOf("img_NoImageBig.png") > 0) {
                        %>
                                    미등록
                        <%
                        	    } else {
                        ...
                        <TD style="TEXT-ALIGN: center" style="border-right:1px solid #9ea2a8">
                        <%
                    ...
                    %>
                    <TR>
                        <TD style="TEXT-ALIGN: center" colspan="8">등록된 내용이 없습니다.</TD>
                    </TR>
                    <%
                    	}
                    %>
