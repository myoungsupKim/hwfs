	...
	try {
		...
		{	
			...
			if (v_CopyType.equals("0"))		// 0 : 사업장식단
			{
				...
				sbSelSql.append("  FROM FSM_TERM_MENU_RECIPE 				\n");
				...
				else
				{
					...
					sbSelSql.append("      ,(SELECT RECIPE_NAME FROM FSR_STD_RECIPE_MST WHERE RECIPE_CD = B.RECIPE_CD) RECIPE_NAME                      \n");
					sbSelSql.append("  FROM FSM_TERM_MENU_MST A                                                                                         \n");
					sbSelSql.append("      ,FSM_TERM_MENU_RECIPE B                                                                                      \n");
					...
					sbInsSql.append("INSERT INTO FSM_TERM_MENU_RECIPE(                                                           	\n");
					sbInsSql.append("	 TERM_MENU_CD                                                                            	\n");
	                ...
	                sbInsSql.append("                 FROM FSM_TERM_MENU_RECIPE B                                                	\n");
			...
			else								// 2 : 기간표준식단
			{
				...
				else
				{
					...
					sbInsSql.delete(0, sbInsSql.length());
					sbInsSql.append("-- 2. 레시피 복사(기간표준) - 대표자재                                                 \n");
					sbInsSql.append("INSERT INTO FSM_TERM_MENU_ITEM(                                                        \n");
					sbInsSql.append("	 TERM_MENU_CD                                                                       \n");
					sbInsSql.append("	, RECIPE_CD                                                                         \n");
					sbInsSql.append("	, ITEM_CODE                                                                         \n");
					sbInsSql.append("   , REP_ITEM_YN                                                                       \n");
					sbInsSql.append("	, CUSER                                                                             \n");
					sbInsSql.append("	, CDATE                                                                             \n");
					sbInsSql.append("	, UUSER                                                                             \n");
					sbInsSql.append("	, UDATE                                                                             \n");
					...
					sbInsSql.append("       , '' UUSER                                                                      \n");
					sbInsSql.append("       , SYSDATE UDATE                                                                 \n");
					sbInsSql.append("  FROM FSM_TERM_MENU_ITEM A                                                            \n");
					sbInsSql.append(" WHERE TERM_MENU_CD = '" + strMenuCD + "'  -- 상단의 선택된 MENU_CD                    \n");
					sbInsSql.append("   AND NOT EXISTS (                                                                    \n");
	                sbInsSql.append("               SELECT 1                                                                \n");
	                sbInsSql.append("                 FROM FSM_TERM_MENU_ITEM B                                             \n");
	                sbInsSql.append("                WHERE B.TERM_MENU_CD = '" + v_MenuCD + "'  -- 위 1번에서 불러온 MENU_CD\n");
					sbInsSql.append("                  AND B.RECIPE_CD = A.RECIPE_CD                                        \n");
					sbInsSql.append("               )                                                                       \n");
