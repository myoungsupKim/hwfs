	...
	try	{
		...
		if(ds_Cond.getString(0, "DIV").equals("U")){
			if(ds_Cond.getString(0, "STYPE").equals("M")){	// 조회구분 : 관리(M)
		        ...
		        sbSql.append("   AND A.INPUT_DD = '" + ds_Cond.getString(0, "INPUT_YM") + "' || '00' /* 월추정 */  \n");
		        sbSql.append("   AND A.DOC_GUBUN = 'R' /* 일실적 */                                                                                                \n");
	        ...
	        //}
		        ...
		        sbSql.append("   AND B.USE_YN = 'Y'                                                                                                              \n");
		        sbSql.append("   AND A.INPUT_YM = '" + ds_Cond.getString(0, "INPUT_YM") + "'  \n");
		        sbSql.append("   AND A.INPUT_DD <> '" + ds_Cond.getString(0, "INPUT_YM") + "' || '00' /* 월추정제외 */ \n");
		        
		        sbSql.append("   AND A.INPUT_DD <> TO_CHAR(ADD_MONTHS(TO_DATE('" + ds_Cond.getString(0, "INPUT_YM") + "' || '01', 'YYYYMMDD'), -12), 'YYYYMM') || '00' /* 전년동월제외 */ \n");
		        ...
		        sbSql.append("                  ' 월추정' \n");
		        sbSql.append("               ELSE \n");
		        sbSql.append("                  TO_CHAR(TO_DATE(A.INPUT_DD, 'YYYY-MM-DD'), 'YYYY-MM-DD')|| ' (' || DECODE(TO_CHAR(TO_DATE(A.INPUT_DD, 'YYYYMMDD'), 'D'), '1', '일', '2', '월', '3', '화', '4', '수', '5', '목', '6', '금', '7', '토') || ')' \n");
	        ...
	        if(!ds_Cond.getString(0, "INPUT_DD").equals("")){
	        	sbSql.append("   AND A.INPUT_DD(+) = '" + ds_Cond.getString(0, "INPUT_DD") + "'  /* 조회년월일 */   \n");
	        } 
