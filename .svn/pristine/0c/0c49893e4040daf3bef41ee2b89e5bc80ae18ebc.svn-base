...
<%
	try	{
        ...
        //sbSql.append("             AND K.TRANS_DATE BETWEEN '20110101' AND TO_CHAR(TO_DATE(T.TRANS_DATE,'YYYYMMDD') -1,'YYYYMMDD')  --시작날짜 고정               \n");
        ...
        //sbSql.append("             AND C.RCV_DATE BETWEEN '20110101' AND TO_CHAR(TO_DATE(T.TRANS_DATE,'YYYYMMDD') -1,'YYYYMMDD')                                  \n");
        //sbSql.append("             AND C.HALL_CODE = '" + v_Hall_Code + "')),0) AS 전일미수                                                                                          \n");
        ...
        sbSql.append("SELECT A.RCV_DATE AS TRANS_DATE                                                                                                             \n");
        sbSql.append("    , 0 매출                                                                                                                                \n");
        sbSql.append("    , 0 반품                                                                                                                                \n");
        sbSql.append("    , 0 순매출                                                                                                                              \n");
        ...
        sbSql.append("  ) T GROUP BY T.TRANS_DATE   ORDER BY T.TRANS_DATE                                                                                         \n");
