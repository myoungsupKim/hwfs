...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * ElctnTaxShetPublishList에 대한 설명 작성
 * @ClassName ElctnTaxShetPublishList.java
 * @Description ElctnTaxShetPublishList Class
 ...
 * </pre>
 */
public class ElctnTaxShetPublishList implements EAIList {
	public List<ElctnTaxShetPublishDTO> dataList = new ArrayList<ElctnTaxShetPublishDTO>();
	/**
	 * getInterfaceId 설명
	 * <pre>
	 * 메소드 상세설명 작성(생략 가능)
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteElctnTaxShetPublish";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertElctnTaxShetPublish";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<ElctnTaxShetPublishDTO>)list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, ElctnTaxShetPublishDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			ElctnTaxShetPublishDTO dto = new ElctnTaxShetPublishDTO();
			dto = (ElctnTaxShetPublishDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			ElctnTaxShetPublishDTO dto = new ElctnTaxShetPublishDTO();
			dto = (ElctnTaxShetPublishDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
