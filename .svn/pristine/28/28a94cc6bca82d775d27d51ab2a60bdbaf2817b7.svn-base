<%
//-----------------------------------------------------------------------------
//■ 시스템명     : 식재영업/수불관리/실적관리/상품별거래유형별 거래실적 조회
//■ 프로그램ID   : FMP00722V_T002.jsp
//■ 프로그램명   : 상품별거래유형별 거래실적 조회-업장별
//■ 작성일자     : 2008.01.31
//■ 작성자       : 노규완
//■ 이력관리     : 2022.02.16
//            1.판매구분 추가
...
***/
		...
		if (sOtcustcd.equals(""))
		{
			if (sChk_Date.equals("1"))  //입고일 포함하여 조회 시...
			{
				...
				sbSql.append( "GROUP BY TRANS_DATE, UPJANG, UPJANGNM_DISP, ITEM_CODE, ITEM_NAME, ITEM_SIZE, PO_UOM, TAX_CODE, ORIGIN_TYPE, CLASS2_NAME, ORDER_TYPE \n");  //#42709 필드 추가
			}
			else //입고일 제외하여 조회 시...
			{
				sbSql.append( ") \n");
				...
				sbSql.append( "GROUP BY UPJANG, UPJANGNM_DISP, ITEM_CODE, ITEM_NAME, ITEM_SIZE, PO_UOM, TAX_CODE, ORIGIN_TYPE, CLASS2_NAME, ORDER_TYPE \n");  //#42709 필드 추가				
			}			
		}
