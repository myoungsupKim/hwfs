...
import com.hwfs.sc.cmn.dto.SmsDTO;
 ...
 /**
 * 배치에서 SMS를 전송하는 SmsSend DAO (배치프레임워크에서 트랜잭션 관리)
 * 
 * @ClassName SmsSendBatchDAO.java
 * @Description SmsSendBatchDAO Class
 ...
 * </pre>
 */
@Repository("/sc/cmn/smsSendBatchDAO")
public class SmsSendBatchDAO extends DefaultBatchDAO {
