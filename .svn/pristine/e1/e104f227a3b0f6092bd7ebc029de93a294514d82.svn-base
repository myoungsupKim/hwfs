...
import java.util.Map;
 ...
 /**
 * 쿠폰회수 내역 관리하는 CouponWithdraw Service Interface
 * 
 * @ClassName CouponWithdrawService.java
 * @Description CouponWithdrawService Class
 ...
 * </pre>
 */
public interface CouponWithdrawService {
	...
	*/
	 ...
	 * @throws Exception
	*/
	String delList(DataSetMap list) throws Exception;
}
