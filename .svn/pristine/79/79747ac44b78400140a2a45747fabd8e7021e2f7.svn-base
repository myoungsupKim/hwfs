...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * ElctnTaxShetHdrList에 대한 설명 작성
 * @ClassName ElctnTaxShetHdrList.java
 * @Description ElctnTaxShetHdrList Class
 ...
 * </pre>
 */
public class ElctnTaxShetHdrList implements EAIList {
	public List<ElctnTaxShetHdrDTO> dataList = new ArrayList<ElctnTaxShetHdrDTO>();
	/**
	 * getInterfaceId 설명
	 * <pre>
	 * 메소드 상세설명 작성(생략 가능)
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteElctnTaxShetHdr";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertElctnTaxShetHdr";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<ElctnTaxShetHdrDTO>)list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, ElctnTaxShetHdrDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			ElctnTaxShetHdrDTO dto = new ElctnTaxShetHdrDTO();
			dto = (ElctnTaxShetHdrDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			ElctnTaxShetHdrDTO dto = new ElctnTaxShetHdrDTO();
			dto = (ElctnTaxShetHdrDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
