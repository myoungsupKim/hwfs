...
<%
	...
	try {
		...
		StringBuffer sbSql = new StringBuffer();				
				...
				sbSql.append(" UPDATE FSR_STD_RECIPE_MST SET RECIPE_NAME='"+NEW_RECIPE_NAME+"' ,UUSER ='"+g_EmpNo+"' ,UDATE=SYSDATE \n ");
				sbSql.append(" WHERE SUBSTR(RECIPE_CD,2,5)    = '"+ RECIPE_CD +"'                                               \n ");
