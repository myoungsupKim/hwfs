...
<DIV id=subContents>
    <DIV class=contents>
        <DIV style="TEXT-ALIGN: center; margin-top:20px;">
            <SPAN STYLE="font-size:20px;"><b>[<%=nullToBlank(rs.getString("CHECK_TYPE_NM"))%>] <%=nullToBlank(rs.getString("UPJANGNM"))%> - 위생 점검 보고서</b></SPAN>
        </DIV>
            ...
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    <TR>
                        ...
                        <TH style="TEXT-ALIGN: center" style="border-right:1px solid #9ea2a8">운영팀장</TH>
                    </TR>
                    <TR>
            ...
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    <TR>
                        ...
                        <TH style="TEXT-ALIGN: center" colspan="3">실무담당자(불합격누적)</TH>
                    ...
                    <TR>
                        ...
                        <TH style="TEXT-ALIGN: center">불합격<br/>누계</TH>
                        ...
                        <TH style="TEXT-ALIGN: center">평균<br/>점수</TH>
                        <TH style="TEXT-ALIGN: center">등급</TH>
                        <TH style="TEXT-ALIGN: center" style="border-right:1px solid #9ea2a8">불합격<br/>누적</TH>
                    </TR>
                    <TR>
                        ...
                        <%
                                if (Integer.parseInt(nullToZero(rs2.getString("UPJANG_NOT_FIT_CNT"))) > 0) {
                        %>
                                <TD style="TEXT-ALIGN: center"><font color = "red"><%=nullToBlank(rs2.getString("UPJANG_NOT_FIT_CNT"))%></font></TD>
                        <%
                                } else {
                        %>
                        ...
                        <%
                                if (Integer.parseInt(nullToZero(rs2.getString("CHARGE_NOT_FIT_CNT"))) > 0) {
                        %>
                                <TD style="TEXT-ALIGN: center"><font color = "red"><%=nullToBlank(rs2.getString("CHARGE_NOT_FIT_CNT"))%></font></TD>
                        <%
                                } else {
                        %>
        ...
        <DIV class=hgtSplit10></DIV>
        <H3><DIV class=title><SPAN>4. 총평 및 특이사항</SPAN></DIV></H3>
        <DIV class="acc_table_basic style1">
        ...
        <DIV class=hgtSplit10></DIV>
        <H3><DIV class=title><SPAN>5. 점검결과 분석</SPAN></DIV></H3>
        <DIV class=title><SPAN>1) 불합격 이력 및 불합격 내역(최근 2년간) - 사업장 기준</SPAN></DIV>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
				<COLGROUP>
				<COL style="WIDTH: 8%">
                ...
                <TBODY id=tbdArea>
                    <TR>
                        ...
                        <TH style="TEXT-ALIGN: center">불합격항목</TH>
                        <TH style="TEXT-ALIGN: center" style="border-right:1px solid #9ea2a8">불합격내용</TH>
                    </TR>
                    <%
                    	int nCnt = 0;
                    	while(rs7.next()) {
                    ...
                    %>
                    <TR>
                        <TD style="TEXT-ALIGN: center"><%=nullToBlank(rs7.getString("CHECK_DATE"))%></TD>
                        <TD style="TEXT-ALIGN: center"><%=nullToBlank(rs7.getString("CHECK_TYPE_NM"))%></TD>
                    	<TD style="TEXT-ALIGN: center"><%=nullToBlank(rs7.getString("CHARGE_NM"))%></TD>
                    	<TD style="TEXT-ALIGN: center"><%=nullToBlank(rs7.getString("CHECK_NUM"))%></TD>
                    	<TD style="TEXT-ALIGN: left"><%=nullToBlank(rs7.getString("CLASS_NAME"))%></TD>
                    	<TD style="TEXT-ALIGN: left"><%=nullToBlank(rs7.getString("EVAL_CONTENTS"))%></TD>
                    </TR>
                    <%
                    	}
                		if(nCnt == 0)
		...
		<DIV class=title><SPAN>2) 불합격 이력 및 불합격 내역(최근 2년간) - 점장 기준</SPAN></DIV>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
				<COLGROUP>
				<COL style="WIDTH: 6%">
                ...
                <TBODY id=tbdArea>
                    <TR>
                    	<TH style="TEXT-ALIGN: center">점장명</TH>
                        <TH style="TEXT-ALIGN: center">점검일자</TH>
                        <TH style="TEXT-ALIGN: center">근무업장명</TH>
                        <TH style="TEXT-ALIGN: center">불합격</TH>
                        <TH style="TEXT-ALIGN: center">불합격항목</TH>
                        <TH style="TEXT-ALIGN: center" style="border-right:1px solid #9ea2a8">불합격내용</TH>
                    </TR>
                    ...
                    %>
                    <TR>
                        <TD style="TEXT-ALIGN: center"><%=nullToBlank(rs8.getString("CHARGE_NM"))%></TD>
                        <TD style="TEXT-ALIGN: center"><%=nullToBlank(rs8.getString("CHECK_DATE"))%></TD>
                    	<TD style="TEXT-ALIGN: left"><%=nullToBlank(rs8.getString("UPJANGNM"))%></TD>
                    	<TD style="TEXT-ALIGN: center"><%=nullToBlank(rs8.getString("CHECK_NUM"))%></TD>
                    	<TD style="TEXT-ALIGN: left"><%=nullToBlank(rs8.getString("CLASS_NAME"))%></TD>
                    	<TD style="TEXT-ALIGN: left"><%=nullToBlank(rs8.getString("EVAL_CONTENTS"))%></TD>
                    </TR>
                    <%
                    	}
                		if(nCnt == 0)
		...
		<DIV class=title><SPAN>3) 일반관리항목 관리이력(정기정검결과에 한함)</SPAN></DIV>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed; padding: 0px; " border=0 cellSpacing=0>
				<COLGROUP>
                ...
                <TBODY style="font-size: 1pt; margin: 0px;">
                    <TR>
                        <TH style="TEXT-ALIGN: center" rowspan = "2">구분</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">개인위생</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">식품보관</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">위생적취급</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">세척소독</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">시설환경</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">고객접점</TH>
                        <TH style="TEXT-ALIGN: center" colspan = "3">서류관리</TH>
                        <TH style="TEXT-ALIGN: center" rowspan = "2" style="border-right:1px solid #9ea2a8">평가점수</TH>
                    </TR>
                    <TR>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">배점</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">득점</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">득점률</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">배점</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">득점</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">득점률</TH>
                        <TH style="TEXT-ALIGN: center; font-size: 8pt">배점</TH>
                    ...
                    %>
                    <TR>
                        <TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("GBN"))%></br><%=nullToBlank(rs9.getString("CHECK_DATE"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_1"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_1"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_1"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_2"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_2"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_2"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_3"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_3"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_3"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_4"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_4"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_4"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_5"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_5"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_5"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_6"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_6"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_6"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("MARK_7"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_7"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("SCORE_RATE_7"))%></TD>
                    	<TD style="TEXT-ALIGN: center; font-size: 8pt"><%=nullToBlank(rs9.getString("TOTAL_SCORE"))%></TD>
                    </TR>
                    <%
                    	}
                    %>
        ...
        <DIV class=hgtSplit10></DIV>
        <H3><DIV class=title><SPAN>6. 주요 지적사항(사진포함)</SPAN></DIV></H3>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                <COLGROUP>
                    <COL style="WIDTH: 7%">
		...
		<DIV class=hgtSplit10></DIV>
        <H3><DIV class=title><SPAN>7. 우수사항</SPAN></DIV></H3>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                <COLGROUP>
                	<COL style="WIDTH: 5%">
		...
		<DIV class=hgtSplit10></DIV>
        <H3><DIV class=title><SPAN>8. 확인사항</SPAN></DIV></H3>
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                <COLGROUP>
                	<COL style="WIDTH: 5%">
