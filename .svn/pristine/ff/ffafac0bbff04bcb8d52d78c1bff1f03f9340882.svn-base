...
<%
	try	{
		...
		if(ds_Cond.getString(0, "DOC_GUBUN").equals("U")){        
	        ...
	        sbSql.append("     , A10.INPUT_YM AS INPUT_YM                                                                                                                   \n");
	        sbSql.append("     , DECODE(B10.CONFIRM_YN, 'Y', '작성완료', 'N', '작성중', '작성전') AS CONFIRM_YN                                                             \n");
	        sbSql.append("     , DECODE((SELECT FST_CLOSE_SABUN FROM MAS_MONTHLY_CLOSE WHERE INPUT_YM = A10.INPUT_YM AND DOC_CD = A10.UPJANG), NULL, 'N', 'Y') AS FST_CLOSE_YN \n");
	        sbSql.append("     , DECODE((SELECT SND_CLOSE_SABUN FROM MAS_MONTHLY_CLOSE WHERE INPUT_YM = A10.INPUT_YM AND DOC_CD = A10.UPJANG), NULL, 'N', 'Y') AS SND_CLOSE_YN \n");
	        
	     	// 팀장(F)인지 기획팀(S)인지 구분
	        if(ds_Cond.getString(0, "USER_DIV").equals("S")){
	        	sbSql.append("     , DECODE((SELECT SND_CLOSE_SABUN FROM MAS_MONTHLY_CLOSE WHERE INPUT_YM = A10.INPUT_YM AND DOC_CD = A10.UPJANG), NULL, '0', '1') AS CLOSE_YN \n");
	        }else{
	        	sbSql.append("     , DECODE((SELECT FST_CLOSE_SABUN FROM MAS_MONTHLY_CLOSE WHERE INPUT_YM = A10.INPUT_YM AND DOC_CD = A10.UPJANG), NULL, '0', '1') AS CLOSE_YN \n");
	        }
	        
	        sbSql.append("  FROM (                                                                                                                                          \n");
	        sbSql.append("        SELECT A.UPJANG, A.UPJANGNM, B.INPUT_YM                                                                                                   \n");
	        sbSql.append("          FROM (                                                                                                                                  \n");
	        ...
	        sbSql.append("               ) A,                                                                                                                               \n");
	        sbSql.append("               (                                                                                                                                  \n");
	        sbSql.append("                SELECT INPUT_YM                                                                                                                   \n");
	        sbSql.append("                  FROM (                                                                                                                          \n");
	        sbSql.append("                        -- 가상테이블                                                                                                             \n");
	        sbSql.append("                        SELECT '" + ds_Cond.getString(0, "INPUT_YY") + "' || LPAD(LEVEL, 2, '0') INPUT_YM                                                                             \n");
	        sbSql.append("                          FROM DUAL                                                                                                               \n");
	        sbSql.append("                         WHERE 1=1                                                                                                                \n");
	        sbSql.append("                       CONNECT BY LEVEL <= 12                                                                                                     \n");
	        sbSql.append("                        )                                                                                                                         \n");
	        sbSql.append("               ) B                                                                                                                                \n");
	        sbSql.append("         WHERE 1 = 1                                                                                                                              \n");
	        ...
	        sbSql.append(" WHERE 1=1                                                                                                                                        \n");
	        sbSql.append("   AND A10.INPUT_YM = B10.INPUT_DD(+)                                                                                                             \n");
	        sbSql.append("   AND A10.UPJANG = B10.DOC_CD(+)                                                                                                                 \n");
	        sbSql.append("   AND B10.DOC_GUBUN(+) = 'P'                                                                                                                     \n");
	        
	        if(!ds_Cond.getString(0, "INPUT_YM").equals("")){
	        	sbSql.append("   AND A10.INPUT_YM = '" + ds_Cond.getString(0, "INPUT_YM") + "'         \n");
	        }
