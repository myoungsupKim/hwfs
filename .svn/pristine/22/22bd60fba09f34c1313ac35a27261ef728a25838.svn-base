...
<DIV id=subContents>
    <DIV class=contents>
        ...
        <br>
        <DIV>
        매출거래처 가상계좌신청을 아래와 같이 요청드리오니 처리하여 주시기 바랍니다.<br>
        </DIV>
        <br>
        <DIV style="TEXT-ALIGN:center;">
        -&nbsp;&nbsp;아&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;래&nbsp;&nbsp;-
        ...
        <br>
        <DIV class=clear></DIV>
        <c:forEach var="result" items="${gwDraftRequestBankAcctNo}" varStatus="status">
	        <DIV class="acc_table_basic style1">
	        	<TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
	                <COLGROUP>
	                    <COL style="WIDTH: 12%;"/>
	                ...
	                <TBODY id=tbdArea>
	                    ...
	                    <TR>
	                        ...
	                        <TD><c:out value="${result.ccNm}"/></TD>
	                        <TH style="text-align:center;">업장명</TH>
	                        <TD colspan="3"><c:out value="${result.upjangnm}"/></TD>
	                    </TR>
	                </TBODY>
	            </TABLE>
	        </DIV>
