...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * ElctnTaxShetStatusSendList에 대한 설명 작성
 * @ClassName ElctnTaxShetStatusSendList.java
 * @Description ElctnTaxShetStatusSendList Class
 ...
 * </pre>
 */
public class ElctnTaxShetStatusSendList implements EAIList {
	public List<ElctnTaxShetStatusSendDTO> dataList = new ArrayList<ElctnTaxShetStatusSendDTO>();
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteElctnTaxShetStatusSend";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertElctnTaxShetStatusSend";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<ElctnTaxShetStatusSendDTO>)list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, ElctnTaxShetStatusSendDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			ElctnTaxShetStatusSendDTO dto = new ElctnTaxShetStatusSendDTO();
			dto = (ElctnTaxShetStatusSendDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			ElctnTaxShetStatusSendDTO dto = new ElctnTaxShetStatusSendDTO();
			dto = (ElctnTaxShetStatusSendDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
