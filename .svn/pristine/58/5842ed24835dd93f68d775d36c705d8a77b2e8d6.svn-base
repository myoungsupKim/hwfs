 ...
 * </pre>
 */
public class AppMasterInterface61Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterface61Tasklet stepExecutionId : " + stepExecutionId);
        ...
        param.put("FROM_UPJANG_CD", "503500");
        param.put("TO_UPJANG_CD", "503999");
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface61Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface61Step", "OK", strRtnMsg);
