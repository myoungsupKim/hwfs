 ...
 * </pre>
 */
@Repository("/batch/ma/mag/spSlaSalsPosMagamProcOutDAO")
public class SpSlaSalsPosMagamProcOutDAO extends DefaultBatchDAO {
     ...
     * @throws Exception
     */
    public Map<String, Object> spSlaSalsPosMagamProcOut(Map<String, Object> parameter) throws Exception {
        //전달 순서대로 설정
        ...
        String procedureName = "SP_SLA_SALS_POS_MAGAM_PROC_OUT";
