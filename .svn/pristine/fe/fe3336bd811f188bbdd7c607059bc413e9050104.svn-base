...
/**
 * 식재앱 구매수발주제한 송신 배치Scheduler Job Class
 * @ClassName AppItemPrecheckInterfaceTasklet.java
 * @Description AppItemPrecheckInterfaceTasklet Class
 ...
 * </pre>
 */
public class AppItemPrecheckInterfaceTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        procCnt = appMasterInterfaceDAO.batchJob4(param);
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppItemPrecheckInterfaceStep", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppItemPrecheckInterfaceStep", "OK", strRtnMsg);
