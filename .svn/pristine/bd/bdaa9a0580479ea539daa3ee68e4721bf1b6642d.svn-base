 ...
 * </pre>
 */
public class AppMasterInterface28Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterface28Tasklet stepExecutionId : " + stepExecutionId);
        ...
        param.put("FROM_UPJANG_CD", "166000");
        param.put("TO_UPJANG_CD", "167999");
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface28Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface28Step", "OK", strRtnMsg);
