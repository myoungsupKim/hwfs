(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("frmExam_003.xfdl", "lib::sz_fsp_xp.xjs");
        this.registerScript("frmExam_003.xfdl", function(exports) {
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("frmExam_003.xfdl", true);
