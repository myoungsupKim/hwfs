...
<%
	...
	try
	{
	    ...
	    sbSql.append("       A.DL_GB,                                                                               \n");
	    sbSql.append("       A.WORK_REP,                                                                            \n");
	    sbSql.append("       A.WORK_TMA,                                                                            \n");
	    sbSql.append("       A.WORK_TMB,                                                                            \n");
	    sbSql.append("       A.WORK_TMC,                                                                            \n");
	    sbSql.append("       A.OTHH,                                                                                \n");
	    sbSql.append("       A.NIGHT_OTHH,                                                                          \n");
	    sbSql.append("       A.HOLI,                                                                                \n");
	    sbSql.append("       A.WORK_TMC + A.OTHH + A.NIGHT_OTHH + A.HOLI AS TOTAL                                   \n");	    
	    ...
	    // 2015.05.11 김진희매니저요청 시급제, 월급제 모두 등록 가능하게 수정
	    //sbSql.append("   AND B.PAY_GB = '002' --근태는 월급제가 아닌 시급제만 등록한다.                             \n");
