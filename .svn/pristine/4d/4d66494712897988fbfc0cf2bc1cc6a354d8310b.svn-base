 ...
 * </pre>
 */
public class AppMasterInterface32Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterface32Tasklet stepExecutionId : " + stepExecutionId);
        ...
        param.put("FROM_UPJANG_CD", "174000");
        param.put("TO_UPJANG_CD", "174999");
        procCnt = appMasterInterfaceDAO.batchJob2(param);
        
        //System.out.println("AppMasterInterface32Tasklet batchJob2 End : " + procCnt);
        if(procCnt > -1)
        {
        ...
        //System.out.println("AppMasterInterface32Tasklet logging");
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            strRtnMsg = LimsUtil.checkNull(retProcVal.get("PO_RTNMSG"));
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface32Step", "FAILED", strRtnMsg);
        ...
        //System.out.println("AppMasterInterface32Tasklet finished");
        strRtnMsg = LimsUtil.checkNull(retProcVal.get("PO_CNT"), 0) + "건이 처리 되었습니다.";
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface32Step", "OK", strRtnMsg);
