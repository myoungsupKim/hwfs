...
<%
	try	{
        ...
        //sbSql.append("SELECT '' RCV_ID, '' RCV_ID_DIS, '' REMARK,                                                                                    \n");
        //sbSql.append("       V.UPJANG,                                                                                                                        \n");
        //sbSql.append("       V.HALL_CODE,                                                                                                                     \n");
        //sbSql.append("       '' RCV_DATE ,                                                                                                                     \n");
        //sbSql.append("       0 RCV_AMT,                                                                                                                       \n");
        //sbSql.append("       0 DISCOUNT_AMT ,                                                                                                                 \n");
        //sbSql.append("       NVL(A.전일매출,0) - (SELECT SUM(RCV_AMT) + SUM(DISCOUNT_AMT) FROM FMW_RCV WHERE RCV_DATE <= TO_CHAR(TO_DATE('" + strDATE + "', 'YYYYMMDD') -1,'YYYYMMDD') AND UPJANG =  '" + strUpjang + "' AND HALL_CODE = '" + strHALL_CODE + "' ) BEFORE_MISU, \n");
        ...
        //sbSql.append("       (SELECT SUM(DISCOUNT_AMT) FROM FMW_RCV WHERE RCV_DATE = '" + strDATE + "'  AND UPJANG =  '" + strUpjang + "' AND HALL_CODE = '" + strHALL_CODE + "') TODAY_DISCOUNT_AMT,                                          \n");
        //sbSql.append("       (SELECT SUM(RCV_AMT) FROM FMW_RCV WHERE RCV_DATE ='" + strDATE + "'  AND UPJANG =  '" + strUpjang + "' AND HALL_CODE = '" + strHALL_CODE + "') TODAY_RCV_AMT                                                     \n");
        ...
        sbSql.append("SELECT '' RCV_ID, '' RCV_ID_DIS, '' REMARK,                                                                                    \n");
        sbSql.append("       DECODE(A.UPJANG,'',B.UPJANG,A.UPJANG) UPJANG,                                                                                                                        \n");
        sbSql.append("       DECODE(A.HALL_CODE,'',B.HALL_CODE,A.HALL_CODE) HALL_CODE,                                                                                                                    \n");
        sbSql.append("       '' RCV_DATE ,                                                                                                                     \n");
        sbSql.append("       0 RCV_AMT,                                                                                                                       \n");
        sbSql.append("       0 DISCOUNT_AMT ,                                                                                                                 \n");
        ...
        //sbSql.append("       (NVL(A.전일매출,0) + NVL(B.당일매출,0)) - NVL((SELECT SUM(RCV_AMT) + SUM(DISCOUNT_AMT) FROM FMW_RCV WHERE RCV_DATE <= '" + strDATE + "'  AND UPJANG =  '" + strUpjang + "' AND HALL_CODE = '" + strHALL_CODE + "'),0) TODAY_MISU,                                         \n");
