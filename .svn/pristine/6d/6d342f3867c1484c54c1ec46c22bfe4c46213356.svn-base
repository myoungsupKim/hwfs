...
import com.hwfs.sc.cmn.dto.LoginDTO;
 ...
 /**
 * 기기/기물관리하는 MachineMstReg Service Interface
 * 
 * @ClassName MachineMstRegService.java
 * @Description MachineMstRegService Class
 ...
 * </pre>
 */
public interface MachineMstRegService {
	/**
	 * 마스터등록 목록을 조회한다.
	 * <pre>
