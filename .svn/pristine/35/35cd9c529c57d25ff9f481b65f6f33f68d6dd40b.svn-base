...
import com.hwfs.fm.fms.service.HubInterfaceMngtService;
 ...
 */
@Controller
@RequestMapping("/fm/fms/hubInterfaceMngt/")
public class HubInterfaceMngtController extends DefaultBatchController {
	
	/** LogService */
	private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** HubInterfaceMngtService Bean 생성 */
	@Resource(name = "/fm/fms/hubInterfaceMngtService")
	private HubInterfaceMngtService hubInterfaceMngtService;
	 ...
	 * @throws Exception
	 */
	@RequestMapping("selectUserIDList.xdo")
	public ModelAndView selectDbJobList(
		...
		RecordSet jobList = hubInterfaceMngtService.selectUserIDList(parameter);
	...
	public ModelAndView saveReturnItem(
		...
		Map<String, Object> rtnMap = hubInterfaceMngtService.saveHubInterface(parameter);
	...
	public ModelAndView selectBatchAuth(
		...
		//권한을(를) 조회한다.
		RecordSet rs = hubInterfaceMngtService.selectBatchAuth(parameter);
