(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"Column0\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"Column0\">홀길동</Col></Row><Row><Col id=\"Column0\">홍길동1</Col></Row><Row><Col id=\"Column0\">홍길동2</Col></Row><Row><Col id=\"Column0\">홍길동3</Col></Row><Row><Col id=\"Column0\">홍길동4</Col></Row><Row><Col id=\"Column0\">홍길동5</Col></Row></Rows>");
            ...
            obj = new Edit("Edit00", "absolute", "10", "80", "295", "47", null, null, this);
            obj.set_taborder("71");
            obj.set_displaynulltext("영업사원명을 입력하세요");
            this.addChild(obj.name, obj);

            obj = new Button("Button14", "absolute", "310", "80", "100", "47", null, null, this);
            obj.set_taborder("72");
            obj.set_text("검색");
            ...
            obj = new Grid("Grid00", "absolute", "10", "137", "400", "301", null, null, this);
            obj.set_taborder("75");
        ...
        this.loadIncludeScript("POPUP_TEMPLATE_03.xfdl", true);
