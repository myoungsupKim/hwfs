...
/**
 * 식재앱 자재마스터 등 송신 배치Scheduler Job Class
 * @ClassName AppMasterInterfaceTasklet.java
 * @Description AppMasterInterfaceTasklet Class
 ...
 * </pre>
 */
public class AppMasterInterfaceTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterfaceTasklet stepExecutionId : " + stepExecutionId);
        ...
        procCnt = appMasterInterfaceDAO.batchJob(param);
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterfaceStep", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterfaceStep", "OK", strRtnMsg);
