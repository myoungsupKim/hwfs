...
import com.hwfs.sc.cmn.dto.LoginDTO;
 ...
 /**
 * 임시여신승인하는 EmergencyLoanApp Service Interface
 * 
 * @ClassName EmergencyLoanAppService.java
 * @Description EmergencyLoanAppService Class
 ...
 * </pre>
 */
public interface EmergencyLoanAppService {
