...
<%
  /**
   * SPOON Backdoor 접속 페이지
   * @ClassName spoon.jsp
   * @Description spoon JSP
...
<HTML>
<HEAD>
<TITLE>SPOON Backdoor Page</TITLE>
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
<SCRIPT LANGUAGE="JavaScript"> 
var sKey  = "SPOON";				//key
var sXadl = "SPOON.xadl";	 		//ADL
...
function fn_launchX()
{
	...
	//spoon인 경우 SSL 적용을 위해 대표 도메인으로 통일 --> nfics.hanwhafoodist.co.kr
	if(Server_Path.indexOf("spoonfs") != -1) {
		Server_Path = Server_Path.replace("sp.spoonfs.co.kr", "nfics.hanwhafoodist.co.kr");
		Server_Path = Server_Path.replace("sp.spoonfs.com", "nfics.hanwhafoodist.co.kr");
		Server_Path = Server_Path.replace("sp.spoonfs.net", "nfics.hanwhafoodist.co.kr");
		Server_Path = Server_Path.replace("sp.spoonfs.kr", "nfics.hanwhafoodist.co.kr");
	}
	...
	XLauncher.globalvalue  = "g_SystemId:g=" + sKey + ",gv_blockMode:g=backdoor";
	XLauncher.launch();
}
