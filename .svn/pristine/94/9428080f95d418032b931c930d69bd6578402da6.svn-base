...
import com.hwfs.sc.cmn.sap.dto.AcctPlanReqDTO;
import com.tobesoft.xplatform.data.DataSet;

 /**
 * AcctPlanReqList에 대한 설명 작성
 * @ClassName AcctPlanReqList.java
 * @Description AcctPlanReqList Class
 ...
 * </pre>
 */
public class AcctPlanReqList implements EAIList {
	public List<AcctPlanReqDTO> dataList = new ArrayList<AcctPlanReqDTO>();
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteAcctPlanReq";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertAcctPlanReq";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<AcctPlanReqDTO>) list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, AcctPlanReqDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for (int i = 0; i < dsm.getRowMaps().size(); i++) {
			AcctPlanReqDTO dto = new AcctPlanReqDTO();
			dto = (AcctPlanReqDTO) DTOUtil.convertMapToVo(dsm.getRowMaps().get(i),
					dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for (int i = 0; i < maps.size(); i++) {
			AcctPlanReqDTO dto = new AcctPlanReqDTO();
			dto = (AcctPlanReqDTO) DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
