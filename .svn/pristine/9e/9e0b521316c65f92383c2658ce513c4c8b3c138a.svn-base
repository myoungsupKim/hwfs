 ...
 * </pre>
 */
@Repository("/batch/sc/fsi/fsiDutyCreateDailyProDAO")
public class FsiDutyCreateDailyProDAO extends DefaultBatchDAO {
    ...
    public Map<String, Object> fsiDutyCreateDailyPro(Map<String, Object> parameter) throws Exception {
        ...
        String procedureName = "FSI_DUTY_CREATE_DAILY_PRO";
