(function()
{
    return function()
    {
        ...
        this.loadTypedefition = function()
        {
            ...
            this._addService("default_typedef.xml", "svc", "JSP", "https://m.hanwhafoodist.co.kr/", "session", null, "", "0", "0");
            ...
            this._addService("default_typedef.xml", "U_svc", "JSP", "https://m.hanwhafoodist.co.kr/hwfs_svc/", "session", null, "", "0", "0");
