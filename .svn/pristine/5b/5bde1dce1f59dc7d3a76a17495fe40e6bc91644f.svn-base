...
import java.util.Map;
 ...
 /**
 * 창고, 품목별로 보관료를 관리.하는 WhbyItembyChargAmt Service Interface
 * 
 * @ClassName WhbyItembyChargAmtService.java
 * @Description WhbyItembyChargAmtService Class
 ...
 * </pre>
 */
public interface WhbyItembyChargAmtService {
