...
<%
	...
	{				
		...
		for(i=0; i< v_SOURCE_DAYS; i++)
		{
				...
				//2) SKIP_YN 이 1이라면 등록된 주기식단이 있을 경우 SKIP 한다. 0이라면 삭제 하고 다시 넣는다.
				...
				//레시피 자재 입력
				sbSql.delete(0, sbSql.length());	
				sbSql.append("INSERT INTO FSH_CYCLE_RECIPE_ITEM  (UPJANG, MENU_CD, RECIPE_CD, ITEM_CODE, ITEM_SEQ, NEED_QTY, EDIBLE_QTY, CUT_SPEC, ORDER_YN, PR_ID, PR_NUM, PR_QTY, NEED_DATE, UNIT_PRICE, MARGIN_RATE, MARGIN_PRICE, CUSER, CDATE, UUSER, UDATE) \n");
