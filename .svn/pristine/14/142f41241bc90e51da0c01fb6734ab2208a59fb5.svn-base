...
<div style=" font-size:smaller; position:absolute; width:300px; height:200px; top:30%; left:50%; margin-left:-330px; margin-top:-100px;">
		...
		<tr>
			<td background="./img/system_bg.jpg" style="padding:170px 45px 45px 45px">
				<table width="100%" style="font-family:dotum;font-size:12px;font-color:#444444;">
					<tr>
						<td><img src="./img/insu_down_list_icon1.gif">프로그램의 설치여부를 묻는 보안경고창이 나타나면 반드시 "<font color="#d55900" style="font-weight:bold">예</font>"를 선택하여 주시기 바랍니다.</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="line-height:25px;"><img src="./img/insu_down_list_icon1.gif">윈도우 XP서비스팩2 사용자께서는 주소 표시줄 아래 경고문구<br><font color="#d55900">"이 사이트에서...여기를 클릭하십시요"</font>를 선택하시어, ACTIVEX 컨트롤을 설치하시기 바랍니다.</td>
					</tr>
					<tr>
						<td height="20px"></td>
					</tr>
					...
					<tr>
						<td align="center">
						<a href = "./installation/Setup_HWFC.exe">
	...
	<div id="msgBoxLayer2" style="display:none;text-align:center;padding-top:10px">
		파일 다운로드 안내창에서 <font color="#FF7300"><strong>[저장] 버튼</strong></font>을 눌러 PC에 저장하신 후 <br><font color="#FF7300">PC에 저장된 "통합설치프로그램(Setup_HWFC.exe)"을 실행</font>하여 <br>안내에 따라 설치하신 후 이용하시기 바랍니다.
	</div>
</div>
<SCRIPT LANGUAGE="JavaScript">
//  XPLATFORM Engine
