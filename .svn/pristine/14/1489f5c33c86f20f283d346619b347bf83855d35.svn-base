...
out_vl.add("fa_Sql", sbSql.toString());
		...
		if (sHeadYn.equals("Y"))
		{
            ...
            sbSql.append("     , NVL(D.TR_AMT,0) AS TR_AMT /* 매입확정(당월) */ \n");
            ...
            sbSql.append("     , NVL(H.BMJ_AMT,0) AS BMJ_AMT /* 전월잔고액 */ \n");
            ...
            sbSql.append("                    AND A.TRANS_DATE2 BETWEEN SUBSTR('"+strNeedDate+"',1,6) || '01' AND SUBSTR('"+strNeedDate+"',1,6) || '31'   \n");
            ...
            sbSql.append("       **************************************************************************/ \n");
            sbSql.append("      ,(SELECT                                                                                                                                                    \n");
            sbSql.append("                       RS.UPJANG AS MAIN_UPJANG                                                                                                                            \n");
            sbSql.append("                     , SUM(RS.AMT - RS.RCP_AMT1) AS BMJ_AMT                                                                                                                \n");
            sbSql.append("                  FROM                                                                                                                                                     \n");
            sbSql.append("                    (                                                                                                                                                      \n");
            sbSql.append("                    -- 채권                                                                                                                                                \n");
            sbSql.append("                        SELECT                                                                                                                                             \n");
            sbSql.append("                            B.MAIN_UPJANG UPJANG                                                                                                                            \n");
            sbSql.append("                          , V.AR_AMT - NVL(V.MNGMV_AMT,0) AS AMT                                                                                                                                \n");
            sbSql.append("                          , 0 AS RCP_AMT1                                                                                                                                   \n");
            sbSql.append("                          FROM SLA_AR_MST V INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                               \n");
            sbSql.append("                                                    AND V.UPJANG_CD=B.UPJANG                                                                                               \n");
            sbSql.append("                                                    AND B.HEAD_CREDIT_YN = 'Y'                                                                                             \n");
            sbSql.append("                                                    AND B.MAIN_UPJANG = " + sMainUpjang + "                                                                                          \n");
            sbSql.append("                         WHERE V.OCCUR_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '31'                       \n");
            sbSql.append("                         AND V.SYS_CLASS IN ('13','14')                                                                                                                    \n");
            sbSql.append("                         AND V.UPJANG_CD IN " + sUpjangList + "                          \n");
            sbSql.append("                         AND V.RECD_STATUS='L'                                                                                                                             \n");
            sbSql.append("                         UNION ALL                                                                                                                                         \n");
            sbSql.append("                    -- 입금                                                                                                                                                \n");
            sbSql.append("                        SELECT                                                                                                                                             \n");
            sbSql.append("                          B.MAIN_UPJANG UPJANG                                                                                                                             \n");
            sbSql.append("                             , 0 AS  AMT                                                                                                                                   \n");
            sbSql.append("                         , NVL(V1.RECEIVE_AMT,0) AS RCP_AMT1                                                                                                               \n");
            sbSql.append("                          FROM SLA_AR_MST V INNER JOIN SLA_AR_RECEIVE_DETAIL V1 ON V1.RECEIVE_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '31' \n");
            sbSql.append("                                                               AND V1.RECD_STATUS = 'L'                                                                                    \n");
            sbSql.append("                                                               AND V.AR_NUM = V1.AR_NUM                                                                                    \n");
            sbSql.append("                                            INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                               \n");
            sbSql.append("                                                               AND V.UPJANG_CD = B.UPJANG                                                                                  \n");
            sbSql.append("                                                               AND B.HEAD_CREDIT_YN = 'Y'                                                                                  \n");
            sbSql.append("                                                               AND B.MAIN_UPJANG = " + sMainUpjang + "                                                                                \n");
            sbSql.append("                         WHERE  1=1                                                                                                                                        \n");
            ...
            sbSql.append("                           AND V.UPJANG_CD IN " + sUpjangList + "                        \n");
            sbSql.append("                           AND V.RECD_STATUS='L'                                                                                                                           \n");
            sbSql.append("                         AND V1.ACCT_CD NOT IN ('11202010')  --대체된 금액은 입금반영이 되지 않도록함  \n");
            sbSql.append("                       UNION ALL                                                                                                                                           \n");
            sbSql.append("                    -- 입금(선수금) : +, -  : 일자별 잔액 개념으로 변경                                                                                                    \n");
            sbSql.append("                    SELECT                                                                                                                                                 \n");
            sbSql.append("                          X.UPJANG                                                                                                                                         \n");
            sbSql.append("                        , 0 AS AMT                                                                                                                                         \n");
            sbSql.append("                        , SUM(X.RCP_AMT1) - SUM(RCP_AMT2) AS RCP_AMT1                                                                                                      \n");
            sbSql.append("                    FROM                                                                                                                                                   \n");
            sbSql.append("                        (                                                                                                                                                  \n");
            sbSql.append("                        -- 선수금 발생금액                                                                                                                                 \n");
            sbSql.append("                            SELECT                                                                                                                                         \n");
            sbSql.append("                                   B.MAIN_UPJANG UPJANG                                                                                                                    \n");
            sbSql.append("                                 , 0 AS  AMT                                                                                                                               \n");
            sbSql.append("                                 , NVL(V.OCCUR_AMT,0) AS RCP_AMT1                                                                                                          \n");
            sbSql.append("                                 , 0 AS RCP_AMT2                                                                                                                           \n");
            sbSql.append("                              FROM SLA_ADVANCE_MST V INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                      \n");
            sbSql.append("                                                           AND  V.UPJANG_CD = B.UPJANG                                                                                     \n");
            sbSql.append("                                                           AND  B.HEAD_CREDIT_YN = 'Y'                                                                                     \n");
            sbSql.append("                                                           AND B.MAIN_UPJANG = " + sMainUpjang + "                                                                                     \n");
            sbSql.append("                             WHERE  V.OCCUR_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '31'                           \n");
            ...
            sbSql.append("                               AND  V.UPJANG_CD IN " + sUpjangList + "                   \n");
            sbSql.append("                            UNION ALL                                                                                                                                      \n");
            sbSql.append("                            -- 선수금 대체금액                                                                                                                             \n");
            sbSql.append("                            SELECT                                                                                                                                         \n");
            sbSql.append("                                   B.MAIN_UPJANG UPJANG                                                                                                                    \n");
            sbSql.append("                                 , 0 AS  AMT                                                                                                                               \n");
            sbSql.append("                                 , 0 AS RCP_AMT1                                                                                                                           \n");
            sbSql.append("                                 , NVL(V1.APPLY_AMT, 0) AS RCP_AMT2                                                                                                        \n");
            sbSql.append("                           FROM SLA_ADVANCE_MST V                                                                                                                          \n");
            sbSql.append("                                            INNER JOIN SLA_ADVANCE_ALT_DETAIL V1 ON 1 = 1                                                                                  \n");
            sbSql.append("                                                           AND V1.RECD_STATUS = 'L'                                                                                        \n");
            sbSql.append("                                                           AND V1.ALT_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '31' \n");
            sbSql.append("                                                           AND V.ADVANCE_NUM = V1.ADVANCE_NUM                                                                              \n");
            sbSql.append("                                            INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                               \n");
            sbSql.append("                                                           AND B.HEAD_CREDIT_YN = 'Y'                                                                                      \n");
            sbSql.append("                                                           AND V.UPJANG_CD = B.UPJANG                                                                                      \n");
            sbSql.append("                                                           AND B.MAIN_UPJANG = " + sMainUpjang + "                                                                                 \n");
            ...
            sbSql.append("                    ) RS                                                                                                                                                   \n");
            sbSql.append("                    GROUP BY RS.UPJANG                                                                                                                                     \n");
            sbSql.append("       ) H \n");
            sbSql.append("       /************************************************************************** \n");
            ...
            */
            ...
            sbSql.append("                                                  AND SL.SHOP_CD IN " + sUpjangList + "                                                                                                            \n");
            sbSql.append("                                                  AND DT.MG_DATE BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '01' AND "+strDate+"                                                                                                                     \n");
            sbSql.append("                                                UNION ALL                                                                                                                                                                                                                            \n");
            ...
            sbSql.append("                                                    WHERE B.TRANS_UPJANG IN " + sUpjangList + "                                                                                                    \n");
            sbSql.append("                                                      AND B.TRANS_DATE BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '01' AND "+strDate+"                                                                                                              \n");
            sbSql.append("                                                ) A                                                                                                                                                                                                                                  \n");
            sbSql.append("                                              , (SELECT UPJANG                                                                                                                                                                                                                       \n");
            sbSql.append("                                                     , MAX(SALE_DATE) AS SALE_DATE                                                                                                                                                                                                   \n");
            sbSql.append("                                                  FROM FMS_SALES                                                                                                                                                                                                                     \n");
            sbSql.append("                                                 WHERE SALE_DATE BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '01' AND '"+strNeedDate+"'                                                                                                                       \n");
            sbSql.append("                                                   AND TRANS_YN = 'Y'                                                                                                                                                                                                                \n");
            sbSql.append("                                                   AND UPJANG IN " + sUpjangList + "                                                                                                               \n");
		...
		{
			sbSql.append("SELECT A.MAIN_UPJANG --T003\n");
            ...
            sbSql.append("       **************************************************************************/ \n");
            sbSql.append("      ,(SELECT                                                                                                                                                    \n");
            sbSql.append("                       RS.UPJANG AS UPJANG                                                                                                                            \n");
            sbSql.append("                     , SUM(RS.AMT - RS.RCP_AMT1) AS BMJ_AMT                                                                                                                \n");
            sbSql.append("                  FROM                                                                                                                                                     \n");
            sbSql.append("                    (                                                                                                                                                      \n");
            sbSql.append("                    -- 채권                                                                                                                                                \n");
            sbSql.append("                        SELECT                                                                                                                                             \n");
            sbSql.append("                               V.UPJANG_CD UPJANG                                                                                                                            \n");
            sbSql.append("                             , V.AR_AMT - NVL(V.MNGMV_AMT,0) AS AMT                                                                                                                                \n");
            sbSql.append("                         , 0 AS RCP_AMT1                                                                                                                                   \n");
            sbSql.append("                          FROM SLA_AR_MST V INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                               \n");
            sbSql.append("                                                    AND V.UPJANG_CD=B.UPJANG                                                                                               \n");
            ...
            sbSql.append("                         WHERE V.OCCUR_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '31'                       \n");
            sbSql.append("                         AND V.SYS_CLASS IN ('13','14')                                                                                                                    \n");
            sbSql.append("                         AND V.UPJANG_CD = " + sUpjang + "                          \n");
            sbSql.append("                         AND V.RECD_STATUS='L'                                                                                                                             \n");
            sbSql.append("                         UNION ALL                                                                                                                                         \n");
            sbSql.append("                    -- 입금                                                                                                                                                \n");
            sbSql.append("                        SELECT                                                                                                                                             \n");
            ...
            */
            ...
            sbSql.append("                                                  AND DT.MG_NO = SL.MG_NO                                                                                                                                                                                                            \n");
            sbSql.append("                                                  AND DT.STS <> 'D'                                                                                                                                                                                                                  \n");
            sbSql.append("                                                  AND SL.SHOP_CD = " + sUpjang + "                                                                                                            \n");
            sbSql.append("                                                  AND DT.MG_DATE BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '01' AND "+strDate+"                                                                                                                    \n");
            sbSql.append("                                                UNION ALL                                                                                                                                                                                                                            \n");
            sbSql.append("                                                   SELECT B.TRANS_ID,                                                                                                                                                                                                                \n");
            sbSql.append("                                                          B.SOURCE_TYPE ,                                                                                                                                                                                                            \n");
            ...
            sbSql.append("                                                          B.SALE_PRICE                                                                                                                                                                                                               \n");
            sbSql.append("                                                     FROM FMS_TRANSACTION B                                                                                                                                                                                                          \n");
            sbSql.append("                                                    WHERE B.TRANS_UPJANG = " + sUpjang + "                                                                                                   \n");
            sbSql.append("                                                      AND B.TRANS_DATE BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE('"+strNeedDate+"', 'YYYYMMDD'), -1), 'YYYYMM') || '01' AND "+strDate+"                                                                                                              \n");
            sbSql.append("                                                ) A                                                                                                                                                                                                                                  \n");
            sbSql.append("                                              , (SELECT UPJANG                                                                                                                                                                                                                       \n");
            sbSql.append("                                                     , MAX(SALE_DATE) AS SALE_DATE                                                                                                                                                                                                   \n");
