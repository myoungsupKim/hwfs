 ...
 *
 * @ClassName FsiStdPriceUpdateProDAO.java
 * @Description FsiStdPriceUpdateProDAO Class
 ...
 * </pre>
 */
@Repository("/batch/sc/fsi/fsiStdPriceUpdateProDAO")
public class FsiStdPriceUpdateProDAO extends DefaultBatchDAO {

    /**
     * 자재표준단가 자동생성 PROCEDURE
     * <pre>
     * 메소드 상세설명 작성(생략 가능)
     * </pre>
     *
     ...
     * @throws Exception
     */
    public Map<String, Object> fsiStdPriceUpdatePro(Map<String, Object> parameter) throws Exception {
        //전달 순서대로 설정
        ...
        String procedureName = "FSI_STD_PRICE_CREATE_PRO";
