...
import com.hwfs.sc.scz.service.AddrMgmtStUpjangService;


 /**
 * 업장마스터 주소를 관리하는 AddrMgmtStUpjang Controller
 * 
 * @ClassName AddrMgmtStUpjangController.java
 * @Description AddrMgmtStUpjangController Class 
 ...
 */
@Controller
@RequestMapping("/sc/scz/addrMgmtStUpjang/")
public class AddrMgmtStUpjangController extends DefaultController {
	
	/** LogService */
	private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** AddrMgmtStUpjangService Bean 생성 */
	@Resource(name = "/sc/scz/addrMgmtStUpjangService")
	private AddrMgmtStUpjangService addrMgmtStUpjangService;
	...
	public ModelAndView selectList(
		...
		//업장마스터 주소 을(를) 조회한다.
		RecordSet rs = addrMgmtStUpjangService.selectList(inVar);
	...
	/**
	 * 업장마스터 주소(을)를 Insert/Update/Delete 처리한다.
	 * <pre>
	 * - 메소드 상세설명 작성(생략 가능)-->생략 시 이 부분 삭제할 것
	 * </pre>
	 *
	...
	public ModelAndView saveList(
		...
		//업장마스터 주소을(를) 등록, 수정, 삭제 처리한다.
		int processCnt = addrMgmtStUpjangService.saveList(parameter);
