...
/*-----------------------------------------------------------------------------
■ 시스템명     : 사업계획관리
■ 프로그램ID   : MAP30220E_T003.jsp
■ 프로그램명   : 마케터별 월추정 관리 확정
■ 작성일자     : 2015-09-01
■ 작성자       : 김태윤
■ 이력관리     : 
-----------------------------------------------------------------------------*/
...
<%
	try	{
		...
		//{
			sbSql.delete(0, sbSql.length());
			sbSql.append("      UPDATE MAP_MON_LOG_MGMT2                           								\n");
		...
		for ( int iRow = 0 ; iRow < 1 ; iRow++ ){
			...
			sbSql.append("         AND PLAN_YEAR = '" + nullToBlank(ds_List.getString(0, "YY")) + "'			\n");
			...
			for ( int iRow = 0 ; iRow < ds_List.getRowCount() ; iRow++ )
			{
				...
				acctPlanReqDTO01.setMmAmt01(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_01")) * 1000));
				acctPlanReqDTO01.setMmAmt02(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_02")) * 1000));
				acctPlanReqDTO01.setMmAmt03(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_03")) * 1000));
				acctPlanReqDTO01.setMmAmt04(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_04")) * 1000));
				acctPlanReqDTO01.setMmAmt05(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_05")) * 1000));
				acctPlanReqDTO01.setMmAmt06(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_06")) * 1000));
				acctPlanReqDTO01.setMmAmt07(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_07")) * 1000));
				acctPlanReqDTO01.setMmAmt08(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_08")) * 1000));
				acctPlanReqDTO01.setMmAmt09(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_09")) * 1000));
				acctPlanReqDTO01.setMmAmt10(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_10")) * 1000));
				acctPlanReqDTO01.setMmAmt11(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_11")) * 1000));
				acctPlanReqDTO01.setMmAmt12(BigDecimal.valueOf( Long.valueOf(ds_List.getString(iRow, "MM_AMT_12")) * 1000));
