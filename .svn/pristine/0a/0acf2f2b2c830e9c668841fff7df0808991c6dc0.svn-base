...
import java.util.Map;
 ...
 /**
 * 업장 레시피 품목을 일괄 변경하는 RecipeBatchChange Service Interface
 * 
 * @ClassName RecipeBatchChangeService.java
 * @Description RecipeBatchChangeService Class
 ...
 * </pre>
 */
public interface RecipeBatchChangeService {
