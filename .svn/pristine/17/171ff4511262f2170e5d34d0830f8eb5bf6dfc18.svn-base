...
//		System.out.println(nullToBlank(ds_cond.getString(0, "ITEM_DETAIL")))	;
		...
		sbSql.append("( \n");
			...
			sbSql.append("                                                           AND  SAL.CUST_GR_DATE  BETWEEN  '" + nullToBlank(ds_cond.getString(0, "S_DATE")) + "' AND '" + nullToBlank(ds_cond.getString(0, "E_DATE")) + "' \n");
			...
			sbSql.append("                                                           AND SAL.SHOP_CD  IN (SELECT UPJANG FROM FMS_UPJANG WHERE MAIN_UPJANG =  " + nullToBlank(ds_cond.getString(0, "MAIN_UPJANG")) + ")                                                               \n");
			sbSql.append("                                                           AND  SAL.CUST_GR_DATE BETWEEN  '" + nullToBlank(ds_cond.getString(0, "S_DATE")) + "' AND '" + nullToBlank(ds_cond.getString(0, "E_DATE")) + "' ) A   \n");
			...
			sbSql.append("   AND A.NEED_DATE BETWEEN '" + nullToBlank(ds_cond.getString(0, "S_DATE")) + "' AND '" + nullToBlank(ds_cond.getString(0, "E_DATE")) + "' \n");
