...
import java.util.Map;
 ...
 /**
 * 입금내역조회하는 ReceiveDescInquiry Service Interface
 * 
 * @ClassName ReceiveDescInquiryService.java
 * @Description ReceiveDescInquiryService Class
 ...
 * </pre>
 */
public interface ReceiveDescInquiryService {
