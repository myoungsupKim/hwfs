...
import static com.hwfs.sc.cmn.util.Scalr.OP_ANTIALIAS;
import static com.hwfs.sc.cmn.util.Scalr.OP_BRIGHTER;
import static com.hwfs.sc.cmn.util.Scalr.OP_DARKER;
import static com.hwfs.sc.cmn.util.Scalr.OP_GRAYSCALE;
import static com.hwfs.sc.cmn.util.Scalr.apply;
