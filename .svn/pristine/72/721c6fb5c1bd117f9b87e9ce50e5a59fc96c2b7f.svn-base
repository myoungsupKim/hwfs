...
import com.hwfs.rc.sle.service.DayTargetMgmtService;
 ...
 */
@Controller
@RequestMapping("/rc/sle/dayTargetMgmt/")
public class DayTargetMgmtController extends DefaultController {
	@Resource(name="/rc/sle/dayTargetMgmtService")
	private DayTargetMgmtService dayTargetMgmt;
	...
	public ModelAndView selectList(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		RecordSet rs = dayTargetMgmt.selectList(parameter);
	...
	public ModelAndView saveData(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		int procCnt =  dayTargetMgmt.saveData(parameter.get("ds_salsGoal"));
	...
	public ModelAndView deleteData(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		int procCnt =  dayTargetMgmt.deleteData(parameter);
