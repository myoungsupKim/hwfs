...
if (typeof bizwell.ewt == "undefined") {
   bizwell.ewt = function(){}
}
if (typeof bizwell.ewt.commons == "undefined") {
	bizwell.ewt.commons = function(){}
}

/* 공통 유틸리티 정의 */
bizwell.ewt.commons.Utils = Util = {
...
bizwell.ewt.commons.XMLUtils = XMLUtil = {
