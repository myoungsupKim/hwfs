...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * SlipCancelList에 대한 설명 작성
 * @ClassName SlipCancelList.java
 * @Description SlipCancelList Class
 * @Modification-Information
 * <pre>
 *    수정일       수정자              수정내용
 *  ----------   ----------   -------------------------------
 *  2015. 5. 29.   Administrator        최초생성
 * </pre>
 ...
 * </pre>
 */
public class SlipCancelList implements EAIList {
	public List<SlipCancelDTO> dataList = new ArrayList<SlipCancelDTO>();
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteSlipCancel";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertSlipCancel";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<SlipCancelDTO>)list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, SlipCancelDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			SlipCancelDTO dto = new SlipCancelDTO();
			dto = (SlipCancelDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			SlipCancelDTO dto = new SlipCancelDTO();
			dto = (SlipCancelDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
