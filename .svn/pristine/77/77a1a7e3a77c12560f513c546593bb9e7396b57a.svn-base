...
import com.hwfs.ft.fsi.dao.SalsplceDAO;
 ...
 /**
 * 매출처 조회하는 Wh Service Implementation
 *
 ...
 * </pre>
 */
@Service("/ft/fsi/salsplceService")
public class SalsplceServiceImpl extends DefaultServiceImpl implements SalsplceService {
    ...
    public RecordSet selectList(Map<String, Object> mapParam) throws Exception {
        return salsplceDAO.selectList(mapParam);
    }
