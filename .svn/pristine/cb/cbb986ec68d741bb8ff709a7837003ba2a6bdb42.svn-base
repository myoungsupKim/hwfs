 ...
 * </pre>
 */
@Repository("/rc/sle/saleWeeklyDAO")
public class SaleWeeklyListDAO extends DefaultDAO {
	...
	public RecordSet selectList(Map<String, Object> parameter) {	 
		return super.queryForRecordSet("rc.sle.saleWeeklyDAO.selectList", parameter);
	}
