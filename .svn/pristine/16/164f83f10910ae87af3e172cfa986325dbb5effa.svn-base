...
import java.util.Map;
 ...
 /**
 * 권한변경을 요청하는 AuthChngRequest Service Interface
 *
 * @ClassName AuthChngRequestService.java
 * @Description AuthChngRequestService Class
 ...
 * </pre>
 */
public interface AuthChngRequestService {
