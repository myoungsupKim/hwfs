	...
	try {
		...
		if (RowCnt > 0)
		{
			...
			{ 
				...
				sbSql.append("  FROM FSC_FORM_MST \n");
				...
				// 1.1.2 insert
				sbSql.delete(0, sbSql.length());
				sbSql.append("INSERT INTO FSC_FORM_MST( \n");
				...
				sbSql.append("	, "	+	nullToZero(ds_Master.getString(0,"MAN_SCORE"))			+" \n");
				sbSql.append(" ) \n");
			...
			else if ( RowStatus == DataSet.ROW_TYPE_UPDATED )
			{
				// 1.2 update
				sbSql.delete(0, sbSql.length());
				sbSql.append("UPDATE FSC_FORM_MST \n");
				...
				sbSql.append("	 , MAN_SCORE = "		+	nullToZero(ds_Master.getString(0,"MAN_SCORE"))			+" \n");
				sbSql.append("WHERE TABLE_TYPE = '"		+	nullToBlank(ds_Master.getString(0,"TABLE_TYPE"))		+"' \n");
		...
		for ( i = 0 ; i < RowCnt ; i++ )
		{
			...
			{
				sbSql.delete(0, sbSql.length());
				sbSql.append("INSERT INTO FSC_CLASS_MST( \n");
				sbSql.append("	  TABLE_TYPE \n");
				sbSql.append("	, FORM_CD \n");
			...
			{
				sbSql.delete(0, sbSql.length());
				sbSql.append("UPDATE FSC_CLASS_MST \n");
		...
		for ( i = 0 ; i < RowCnt ; i++ )
		{
			...
			if ( RowStatus == DataSet.ROW_TYPE_INSERTED )
			{
				...
				sbSql.delete(0, sbSql.length());
				sbSql.append("INSERT INTO FSC_FORM_DTL( \n");
				sbSql.append("	  TABLE_TYPE \n");
				sbSql.append("	, FORM_CD \n");
				sbSql.append("	, CLASS_CD \n");
			...
			else if ( RowStatus == DataSet.ROW_TYPE_UPDATED )
			{
				...
				sbSql.delete(0, sbSql.length());
				sbSql.append("UPDATE FSC_FORM_DTL \n");
