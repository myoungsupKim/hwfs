...
import java.util.Map;
 ...
 /**
 * 입금상세조회하는 ReceiveDetailInquiry Service Interface
 * 
 * @ClassName ReceiveDetailInquiryService.java
 * @Description ReceiveDetailInquiryService Class
 ...
 * </pre>
 */
public interface ReceiveDetailInquiryService {
