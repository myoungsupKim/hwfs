...
public class PbItemMgmtServiceImpl extends DefaultServiceImpl implements PbItemMgmtService {
	...
	*/
	@Override
	public int saveList(DataSetMap dataSetMap, DataSetMap dataCol, LoginDTO loginDTO) throws Exception {
		
		int changeRowCnt=0;
		String strChk = "0";
		
		// 튜프 체크 해서 익셉션 던지기
		String resultString = selectItemCode(dataSetMap);
	 ...
	 */
	@Override
	public String selectItemCode(DataSetMap dataSetMap) throws Exception {
		String itemCodeArr = "''";
		...
		List<Map> itemCodeLst = pbItemMgmtDAO.selectItemCodeList(itemCodeArr);
