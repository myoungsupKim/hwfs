            ...
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                        ...
                        <TD COLSPAN="2">
                            <DIV class="acc_table_basic style1 list">
                                <TABLE border=0 cellSpacing=0>
                                    <TBODY>
                                        <TR>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 15%">품목명</TH>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 13%">등급/규격</TH>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 7%">단위</TH>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 12%">수량</TH>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 12%">중량</TH>
                                            <TH ROWSPAN="2" style="TEXT-ALIGN: center; WIDTH: 12%">예상원가(￦)</TH>
                                            <TH COLSPAN="2" style="TEXT-ALIGN: center;" style="border-right:1px solid #9ea2a8">매입금액	</TH>
                                        </TR>
                                        <TR>
                                            <TH style="TEXT-ALIGN: center; WIDTH: 15%" style="border-right:1px solid #9ea2a8">AMOUNT($)</TH>
                                            <TH style="TEXT-ALIGN: center; WIDTH: 15%" style="border-right:1px solid #9ea2a8">예상매입액(￦)</TH>
                                        </TR>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="TEXT-ALIGN: left" class=rbnone><c:out value="${record.gradeStand}"/></TD>
                                            ...
                                            <TD style="TEXT-ALIGN: right"><fmt:formatNumber value="${record.calAmount}" type="number" pattern="#,##0.00"/></TD>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="TEXT-ALIGN: left" class=rbnone></TD>
                    ...
                    <TR>
                        <TD>&nbsp;(3) 비고</TD>
                        <TD>
                            <c:out value="${fn:replace(fn:replace(gwDraftInfo.dealScaleRemark, newline, '<br/>'),' ','&nbsp;')}" escapeXml="false"/><br />
                        </TD>
                    </TR>
            ...
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                                    ...
                                    <TBODY>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="TEXT-ALIGN: left" style="border-right:1px solid #9ea2a8">
                                                ...
                                                - 신용장개설일 : <fmt:formatDate value="${lcIssuingSchdDate}" pattern="yyyy-MM-dd"/>
                                                <BR>
                                                <fmt:parseDate var="lshipSchdDate" value="${gwDraftInfo.lshipSchdDate}" pattern="yyyyMMdd"/>
                                                - 선적예정일 : <fmt:formatDate value="${lshipSchdDate}" pattern="yyyy-MM-dd"/>
                                                <BR>
                                                <fmt:parseDate var="arrivSchdDate" value="${gwDraftInfo.arrivSchdDate}" pattern="yyyyMMdd"/>
                                                - 입항예정일 : <fmt:formatDate value="${arrivSchdDate}" pattern="yyyy-MM-dd"/>
                                                <BR>
                                                <fmt:parseDate var="deliverSchdDate" value="${gwDraftInfo.deliverSchdDate}" pattern="yyyyMMdd"/>
                                                - 입고예정일 : <fmt:formatDate value="${deliverSchdDate}" pattern="yyyy-MM-dd"/>
                                                <BR>
                                                <fmt:parseDate var="entrySchdDate" value="${gwDraftInfo.entrySchdDate}" pattern="yyyyMMdd"/>
                                                - 통관예정일 : <fmt:formatDate value="${entrySchdDate}" pattern="yyyy-MM-dd"/>
                                            </TD>
                    ...
                    <TR>
                        <TD>(3) 비고</TD>
                        <TD>
                            <c:out value="${fn:replace(fn:replace(gwDraftInfo.dealCondRemark, newline, '<br/>'),' ','&nbsp;')}" escapeXml="false"/><br />
                        </TD>
                    </TR>
                </TBODY>
            </TABLE>
        ...
        <DIV class="acc_table_basic style1">
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    ...
                    <TR>
                        <TD COLSPAN="2">&nbsp;(2) BL 결제 및 부대비용</TD>
                    </TR>
                    <TR>
                        <TD COLSPAN="2">
                            <DIV class="acc_table_basic style1 list">
                                <TABLE border=0 cellSpacing=0">
                                    <TBODY>
                                        <TR>
                                            <TH style="TEXT-ALIGN: center; WIDTH: 50%">품목명</TH>
                                            <TH style="TEXT-ALIGN: center; WIDTH: 25%">BL 대금(￦)</TH>
                                            <TH style="TEXT-ALIGN: center; WIDTH: 25%" style="border-right:1px solid #9ea2a8">통관 및 부대비용(￦)</TH>
                                        </TR>
                                        <TR>
                                            <TD style="TEXT-ALIGN: left" class=rbnone><%=rs2.get(0).get("itemNm")%>등 <%=rs2.size()-1 %>개 품목</TD>
                                            <TD style="TEXT-ALIGN: right" class=rbnone><fmt:formatNumber value="${gwDraftInfo.expectBlAmt}" type="number"/></TD>
                                            <TD style="TEXT-ALIGN: right"><fmt:formatNumber value="${gwDraftInfo.entryOtherAmt}" type="number"/></TD>
                                        </TR>
                                    </TBODY>
                                </TABLE>
                            </DIV>
            ...
            <TABLE style="TABLE-LAYOUT: fixed" border=0 cellSpacing=0>
                ...
                <TBODY id=tbdArea>
                    <TR>
                        <TD>&nbsp;(1) 채권 관리 </TD>
                        <TD>
                            <c:out value="${fn:replace(fn:replace(gwDraftInfo.arMgmtSchm, newline, '<br/>'),' ','&nbsp;')}" escapeXml="false"/>
                        </TD>
                    </TR>
                    <TR>
                    ...
                    <TR>
                        <TD>&nbsp;(4)비고 </TD>
                        <TD>
                        <c:out value="${fn:replace(fn:replace(gwDraftInfo.priceMgmtRemark, newline, '<br/>'),' ','&nbsp;')}" escapeXml="false"/><br />
                        </TD>
                    </TR>
                </TBODY>
            </TABLE>
