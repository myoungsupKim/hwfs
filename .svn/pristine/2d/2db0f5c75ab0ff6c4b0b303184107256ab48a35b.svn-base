...
import com.hwfs.sc.cmn.dto.LoginDTO;
 ...
 /**
 * 세금계산서 발행을 관리하는 TaxInvoiceMgntHq Service Interface
 * 
 * @ClassName TaxInvoiceMgntHqService.java
 * @Description TaxInvoiceMgntHqService Class
 ...
 * </pre>
 */
public interface TaxInvoiceMgntHqService {
	...
	*/
	 ...
	 * @throws Exception
	*/
	int saveTaxInvoice(DataSetMap taxShetMst, DataSetMap taxShetDtl, DataSetMap taxShetOccurObj) throws Exception;
	...
	*/
	...
	/**
	 * 수정 세금계산서의 원본 세금계산서의 데이터를 삭제한다.
	 *
	 * @return 처리건수
	 * @throws Exception
	*/
	int deleteTaxInvoiceOrgnl(DataSetMap list) throws Exception;
	...
	*/
	 ...
	 * @throws Exception
	*/
	RecordSet selectInvoiceRcvr(Map<String, Object> mapParam) throws Exception;
