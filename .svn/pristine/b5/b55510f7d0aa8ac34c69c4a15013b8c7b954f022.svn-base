...
import com.hwfs.rc.sle.service.MonTargetMgmtService;

 /**
 * MonTargetMgmtController에 대한 설명 작성
 * @ClassName MonTargetMgmtController.java
 * @Description MonTargetMgmtController Class 
 ...
 */
@Controller
@RequestMapping("/rc/sle/monTargetMgmt/")
public class MonTargetMgmtController extends DefaultController {
	@Resource(name="/rc/sle/monTargetMgmtService")
	private MonTargetMgmtService monTargetMgmt;
	...
	public ModelAndView selectList(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		RecordSet rs = monTargetMgmt.selectList(parameter);
		
		//개인정보보호 접근로그 조회 조건과 건수
		//accessLogService.readLog(parameter, rs.size());
				
		//XPlatform으로 넘겨줄 Dataset을 설정한다.
		super.addOutDataSet(mav, "ds_salsGoal", rs);
	...
	public ModelAndView saveData(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		int procCnt =  monTargetMgmt.saveData(parameter.get("ds_salsGoal"));
	...
	public ModelAndView deleteData(@Bind(id = "", type = XplatformMapDTO.class) XplatformMapDTO xpDTO) throws Exception {
		...
		int procCnt =  monTargetMgmt.deleteData(parameter);
