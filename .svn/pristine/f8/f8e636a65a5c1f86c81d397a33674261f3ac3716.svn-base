...
/*-----------------------------------------------------------------------------
■ 시스템명     : 사업계획관리
■ 프로그램ID   : MAP30220E_T002.jsp
■ 프로그램명   : 마케터별 월추정 관리 저장
■ 작성일자     : 2015-09-01
■ 작성자       : 김태윤
■ 이력관리     :
-----------------------------------------------------------------------------*/
...
<%
    try	{
        ...
        if("0".equals(isData)){
            ...
            //sbSql.append("INSERT INTO MAP_MON_LOG_MGMT2															\n");
            //sbSql.append("		 (TM_CD, SABUN, UPJANG, YY, BIZ_CLASS, CONFIRM_YN, BPC_SEND_YN, CDATE, CUSER, UDATE, UUSER )						 		\n");
            ...
            sbSql.append(" MERGE INTO MAP_MON_LOG_MGMT2 A \n");
            sbSql.append(" USING DUAL \n");
            sbSql.append(" ON ( \n");
            sbSql.append("      A.TM_CD = '" + nullToBlank(ds_Cond.getString(0, "TM_CD")) + "'     \n");
            ...
            sbSql.append("     INSERT (TM_CD, SABUN, UPJANG, YY, BIZ_CLASS, CONFIRM_YN, BPC_SEND_YN, CDATE, CUSER, UDATE, UUSER ) VALUES ( \n");
        ...
        for ( int iRow = 0 ; iRow < ds_List.getRowCount() ; iRow++ )
        {
            ...
            sbSql.delete(0, sbSql.length());
            sbSql.append("MERGE INTO MAP_MON_PLAN2 A 															\n");
            ...
            sbSql.append("            , '" + nullToBlank(ds_Cond.getString(0, "TM_CD")) + "' AS TM_CD 			\n");
            ...
            sbSql.append("       A.TM_CD      	= B.TM_CD 		AND        										\n");
            ...
            sbSql.append("             , '" + nullToBlank(ds_Cond.getString(0, "TM_CD")) + "' 					\n");
            sbSql.append("             , '" + nullToBlank(ds_Cond.getString(0, "SABUN")) + "' 					\n");
            // 영엉이익 계정에 CC_CD가 없을때 처리.
            sbSql.append("             , DECODE('" + nullToBlank(ds_List.getString(iRow, "ACCT_CD")) + "', '44000000', '" + nullToBlank(ds_List.getString(iRow-1, "CC_CD")) + "', '" + nullToBlank(ds_List.getString(iRow, "CC_CD")) + "') 		\n");
