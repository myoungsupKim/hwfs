...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * ElctnTaxShetItemList에 대한 설명 작성
 * @ClassName ElctnTaxShetItemList.java
 * @Description ElctnTaxShetItemList Class
 ...
 * </pre>
 */
public class ElctnTaxShetItemList implements EAIList {
	public List<ElctnTaxShetItemDTO> dataList = new ArrayList<ElctnTaxShetItemDTO>();
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteElctnTaxShetItem";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertElctnTaxShetItem";
	}
	...
	*/
	...
	public void setDataList(List<?> list) {
		dataList = (List<ElctnTaxShetItemDTO>)list;
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, ElctnTaxShetItemDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			ElctnTaxShetItemDTO dto = new ElctnTaxShetItemDTO();
			dto = (ElctnTaxShetItemDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			ElctnTaxShetItemDTO dto = new ElctnTaxShetItemDTO();
			dto = (ElctnTaxShetItemDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
