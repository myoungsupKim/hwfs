...
import com.hwfs.sc.scz.service.AddrMgmtScoUpjangMstService;


 /**
 * 사업장 주소정제를 보정하는 AddrMgmtScoUpjangMst Controller
 * 
 * @ClassName AddrMgmtScoUpjangMstController.java
 * @Description AddrMgmtScoUpjangMstController Class 
 ...
 */
@Controller
@RequestMapping("/sc/scz/addrMgmtScoUpjangMst/")
public class AddrMgmtScoUpjangMstController extends DefaultController {
	
	/** LogService */
	private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** AddrMgmtScoUpjangMstService Bean 생성 */
	@Resource(name = "/sc/scz/addrMgmtScoUpjangMstService")
	private AddrMgmtScoUpjangMstService addrMgmtScoUpjangMstService;
	...
	public ModelAndView selectList(
		...
		//사업장 주소 을(를) 조회한다.
		RecordSet rs = addrMgmtScoUpjangMstService.selectList(inVar);
	...
	/**
	 * 사업장 주소(을)를 Insert/Update/Delete 처리한다.
	 * <pre>
	 * - 메소드 상세설명 작성(생략 가능)-->생략 시 이 부분 삭제할 것
	 * </pre>
	 *
	...
	public ModelAndView saveList(
		...
		//사업장 주소을(를) 등록, 수정, 삭제 처리한다.
		int processCnt = addrMgmtScoUpjangMstService.saveList(parameter);
