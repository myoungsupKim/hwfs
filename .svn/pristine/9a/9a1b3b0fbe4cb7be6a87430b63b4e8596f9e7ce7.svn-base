...
out_vl.add("fa_Sql", sbSql.toString());
		...
		if (sHeadYn.equals("Y"))
		{
            ...
            sbSql.append("     , NVL(H.BMJ_AMT,0) AS BMJ_AMT /* 전월기말잔고 */ \n");
            ...
            sbSql.append("       **************************************************************************/ \n");
            sbSql.append("     , (SELECT B.MAIN_UPJANG \n"); 
            sbSql.append("             , SUM(NVL(A.RECEIVE_AMT,0)) AS RECEIVE_AMT \n"); 
            sbSql.append("          FROM (SELECT M.UPJANG_CD \n"); 
            sbSql.append("                     , M.AR_NUM \n"); 
            sbSql.append("                     , (SELECT NVL(SUM(D.RECEIVE_AMT),0) \n");  
            sbSql.append("                          FROM SLA_AR_RECEIVE_DETAIL D \n");  
            sbSql.append("                         WHERE D.RECD_STATUS  = 'L' \n");  
            sbSql.append("                           AND D.RECEIVE_DATE BETWEEN SUBSTR(TO_CHAR(SYSDATE, 'YYYYMMDD'), 1, 6)||'01' AND SUBSTR(TO_CHAR(SYSDATE, 'YYYYMMDD'), 1, 6)||'31' \n"); 
            sbSql.append("                           AND D.AR_NUM = M.AR_NUM) AS RECEIVE_AMT \n"); 
            sbSql.append("                  FROM SLA_AR_MST M \n"); 
            sbSql.append("                 WHERE M.SYS_CLASS = '13' \n"); 
            sbSql.append("                   AND M.RECD_STATUS = 'L' \n"); 
            sbSql.append("                   AND M.UPJANG_CD IN " + sUpjangList + " \n");  
            sbSql.append("               ) A, FMS_UPJANG B \n");  
            sbSql.append("         WHERE A.UPJANG_CD = B.UPJANG \n");
            sbSql.append("           AND B.HEAD_CREDIT_YN = 'Y' \n");
            sbSql.append("         GROUP BY B.MAIN_UPJANG \n"); 
            sbSql.append("       ) G \n");
            sbSql.append("       /************************************************************************** \n");
            ...
            sbSql.append("             , V.AR_AMT AMT                                                                                                                                                  \n");
            sbSql.append("             , V.OCCUR_DATE BOND_DATE                                                                                                                                        \n");
            ...
            sbSql.append("         WHERE V.OCCUR_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE(TO_CHAR(SYSDATE, 'YYYYMMDD'), 'YYYYMMDD'), -1), 'YYYYMM') || '31'                                                \n");
            ...
            sbSql.append("             , V1.RECEIVE_DATE BOND_DATE                                                                                                                                     \n");
            sbSql.append("	     , NVL(V1.RECEIVE_AMT,0) AS RCP_AMT1                                                                                                                                    \n");
            sbSql.append("          FROM SLA_AR_MST V INNER JOIN SLA_AR_RECEIVE_DETAIL V1 ON V1.RECEIVE_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE(TO_CHAR(SYSDATE, 'YYYYMMDD'), 'YYYYMMDD'), -1), 'YYYYMM') || '31' \n");
            sbSql.append("											   AND V1.RECD_STATUS = 'L'                                                                                                                                       \n");
            sbSql.append("											   AND V.AR_NUM = V1.AR_NUM                                                                                                                                       \n");
            sbSql.append("									 INNER JOIN FMS_UPJANG B ON 1 = 1                                                                                                                                   \n");
            sbSql.append("											   AND   (B.UPJANG IN " + sUpjangList + ")                                                                                                                                     \n");
            sbSql.append("											   AND V.UPJANG_CD = B.UPJANG                                                                                                                                     \n");
            sbSql.append("         WHERE  V.SYS_CLASS IN ('13','14')                                                                                                                                   \n");
            sbSql.append("	  AND    V.RECD_STATUS='L'                                                                                                                                                  \n");
            sbSql.append("       UNION ALL                                                                                                                                                             \n");
            ...
            sbSql.append("                   V.UPJANG_CD UPJANG                                                                                                                                        \n");
            sbSql.append("                 , 0 AS  AMT                                                                                                                                                 \n");
            sbSql.append("                 , V.OCCUR_DATE AS  BOND_DATE                                                                                                                                \n");
            ...
            sbSql.append("                   V.UPJANG_CD UPJANG                                                                                                                                        \n");
            sbSql.append("                 , 0 AS  AMT                                                                                                                                                 \n");
            sbSql.append("                 , V1.ALT_DATE AS  BOND_DATE                                                                                                                                 \n");
            sbSql.append("                 , 0 AS RCP_AMT1                                                                                                                                             \n");
            ...
            sbSql.append("													AND V1.RECD_STATUS = 'L'                                                                                                                                        \n");
            sbSql.append("													AND V1.ALT_DATE BETWEEN '19000101' AND TO_CHAR(ADD_MONTHS(TO_DATE(TO_CHAR(SYSDATE, 'YYYYMMDD'), 'YYYYMMDD'), -1), 'YYYYMM') || '31'                                               \n");
            ...
            sbSql.append("	   AND V.RECD_STATUS='L'                                                                                                                                                    \n");
            sbSql.append("	 ) X                                                                                                                                                                        \n");
            sbSql.append("	GROUP BY X.UPJANG, X.BOND_DATE                                                                                                                                              \n");
            sbSql.append("    ) RS                                                                                                                                                                     \n");
		...
		else
		{
            ...
            sbSql.append("     , NVL(C1.PRE_AMT,0) AS PRE_AMT /* 선수잔액 */ \n");
            sbSql.append("     , NVL(C.RMN_AMT,0) - NVL(C1.PRE_AMT,0) + NVL(D.TR_AMT,0) + NVL(E.PO_AMT,0) + NVL(F.PR_AMT,0) AS BOND_AMT /* 채권잔액*/ \n");
