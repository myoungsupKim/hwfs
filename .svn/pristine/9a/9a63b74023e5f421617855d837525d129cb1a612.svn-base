(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("ShoppingFicsBasket_copy.xfdl", "lib::lib_Com.xjs");
        this.registerScript("ShoppingFicsBasket_copy.xfdl", function(exports) {
        //########################################################
        ...
        this.fn_init = function ()
        {
        	...
        	this.div_search.edt_totalAmt.set_value("총합계: " + this.gfn_NumFormat(this.ds_grd.getSum("OP_AMOUNT")) + "원");	
        ...
        ********************************************************************************/
        ...
        {		
        	...
        	strArgument += " sGubunNewOrOld=" + nexacro.wrapQuote(fn_gubunNewOrOld);
        	strArgument += " sMaxPrNum=" + nexacro.wrapQuote(fn_maxPrNum);
        	strArgument += " sMaxApproveNum=" + nexacro.wrapQuote(fn_maxApproveNum);
        ...
        ********************************************************************************/
        this.fn_ChkData = function ()
        {
        	...
        	for (i=0; i<this.ds_grd.rowcount; i++)
        	{
        		...
        		//-----------------------------------------------------------------------------------
        		if ((this.ds_grd.getColumn(i,"MAX_ORD_QTY") > 0) && ( this.ds_grd.getCaseSum("ITEM_CODE=='"+ this.ds_grd.getColumn(i,"ITEM_CODE")+"'&& (LINE_STATUS != '005' && LINE_STATUS != '003') && DOCU_SOURCE != '01 BO'","PR_QTY") > this.ds_grd.getColumn(i,"MAX_ORD_QTY")))  
        		{   
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("ShoppingFicsBasket_copy.xfdl", true);
