...
<%
    ...
    try	{
        ...
        sbSql.append("     , CASE WHEN E.G_PRICE < A.G_ITEM_PRICE THEN 'Y' ELSE 'N' END AS CHEAP_YN                                             \n");
        ...
        sbSql.append("     , ( SELECT ITEM_CLASS4, CONTRACT_START, CONTRACT_END, MIN(G_PRICE) G_PRICE                                           \n");
        sbSql.append("             FROM (                                                                                                       \n");
        sbSql.append("            SELECT D.ITEM_CLASS4,                                                                                         \n");
        sbSql.append("                   A.CONTRACT_START,                                                                                      \n");
        sbSql.append("                   A.CONTRACT_END,                                                                                        \n");
        sbSql.append("                    ROUND(DECODE(A.MARGIN_RATE,0,A.CONTRACT_PRICE,(ROUND((A.CONTRACT_PRICE+(A.CONTRACT_PRICE*A.MARGIN_RATE/100))/10)*10))/DECODE(D.KG_CONVERT_RATE,0,1,D.KG_CONVERT_RATE)/1000,2) G_PRICE  \n");
        sbSql.append("               FROM FCUS.ST_UPJANG B,                                                                                     \n");
        sbSql.append("                    FCUS.PO_CONTRACT_F A,                                                                                 \n");
        sbSql.append("                    FCUS.HLDC_PO_ITEM_MST D                                                                               \n");
        sbSql.append("              WHERE A.ITEM_CODE = D.ITEM_CODE                                                                             \n");
        sbSql.append("                AND A.USE_YN = 'Y'                                                                                        \n");
        sbSql.append("                AND A.CONTRACT_PRICE > 0                                                                                  \n");
        sbSql.append("                AND A.UPJANG = B.AP_UNITPRICE_UPJANG                                                                      \n");
        sbSql.append("                AND B.UPJANG = ?)                                                                                         \n");
        sbSql.append("                GROUP BY ITEM_CLASS4, CONTRACT_START, CONTRACT_END                                                        \n");
        sbSql.append("         ) E                                                                                                              \n");
        ...
        sbSql.append("   AND A.NEED_DATE BETWEEN E.CONTRACT_START(+) AND E.CONTRACT_END(+)                                                      \n");
