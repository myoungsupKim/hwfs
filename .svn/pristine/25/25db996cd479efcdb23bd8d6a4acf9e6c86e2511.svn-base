...
*/
				//기존 작성한 레시피의 실제 D-Day(제공일-입고예정일)를 복사 시 적용하여 입고예정일(제공일-DDay)을 구한다.
/*
...
*/
				...
				sbInsSql.append("             WHERE F.UPJANG = " + v_Upjang + " -- 복사될 사업장 \n");
				sbInsSql.append("               AND F.MENU_CD = '" + v_MenuCD + "'  -- 복사될 MENU_CD \n");
				...
				sbInsSql.append("             WHERE B.UPJANG = " + v_Upjang + " -- 복사될 사업장                               			 		\n");   
				sbInsSql.append("               AND B.MENU_CD = '" + v_MenuCD + "'  -- 복사될 MENU_CD                           	\n"); 
...
*/
				...
				sbInsSql.append("             WHERE C.UPJANG = " + v_Upjang + " -- 복사될 사업장                               			 		\n");   
				sbInsSql.append("               AND C.MENU_CD = '" + v_MenuCD + "'  -- 복사될 MENU_CD                           	\n"); 
...
*/
				...
				sbSelSql.append("                WHERE C.UPJANG = '" + strUpjang + "'  -- 상단의 선택된 MENU_CD                                     			\n");
				sbSelSql.append("                  AND C.MENU_CD = '" + strMenuCD + "'  -- 상단의 선택된 MENU_CD                                     			\n");
				sbSelSql.append("                  AND C.RECIPE_CD = B.RECIPE_CD                                                                            \n");
				sbSelSql.append("               )                                                                                                           \n");
