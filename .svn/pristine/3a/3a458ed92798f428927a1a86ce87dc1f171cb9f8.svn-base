...
/**
 * 시험결과등록-시험항목별 Serive Class
 *
 * @ClassName TestResulTestArticleRegService.java
 * @Description TestResulTestArticleRegService Class
 ...
 * </pre>
 */
public interface TestResulTestArticleRegService {
