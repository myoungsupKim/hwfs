...
<%
    try {
        ...
        // 점검표 등록 후 수정불가 및 상단조회조건에 '전체'추가
        //============================================================================================
        sbSql.append("     ,(SELECT CODE_NAME FROM SCC_COMMON_CODE WHERE GROUP_CODE = 'FS9041' AND CODE = A.TABLE_TYPE) AS TYPE_NAME \n");
        //============================================================================================
        //(2009-01-14 추가) 시작
        //============================================================================================
        ...
        sbSql.append("     , (SELECT COUNT(*) FROM FSC_SAFE_RESULT_MST WHERE A.TABLE_TYPE = TABLE_TYPE AND A.FORM_CD = FORM_CD) AS CNT \n");
        sbSql.append("  FROM FSC_SAFE_FORM_MST A \n");
