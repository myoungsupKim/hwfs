...
import com.hwfs.fs.fse.service.EventApprovalService;


 /**
 * 등록된 업장을 승인하는 EventApproval Controller
 * 
 * @ClassName EventApprovalController.java
 * @Description EventApprovalController Class 
 ...
 */
@Controller
@RequestMapping("/fs/fse/eventApproval/")
public class EventApprovalController extends DefaultController {
	
	/** LogService */
	//private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** EventApprovalService Bean 생성 */
	@Resource(name = "/fs/fse/eventApprovalService")
	...
	public ModelAndView selectList(
		...
		//업장승인 을(를) 조회한다.
		RecordSet rs = eventApprovalService.selectList(inVar);
	...
	public ModelAndView selectLog(
		...
		//업장승인 을(를) 조회한다.
		RecordSet rs = eventApprovalService.selectLog(inVar);
	...
	public ModelAndView saveList(
		...
		int processCnt = eventApprovalService.saveList(parameter, inVar.get("approvalStatusCd").toString(), inVar.get("approvalRemark").toString());
