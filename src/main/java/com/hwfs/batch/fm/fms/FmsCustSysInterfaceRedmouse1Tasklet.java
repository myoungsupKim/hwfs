...
import com.hwfs.batch.fm.fms.dao.FmsCustSysInterfaceRedmouse1DAO;
import com.hwfs.cmn.exception.BizException;
import com.hwfs.ls.cmn.util.LimsUtil;
import com.hwfs.sc.scb.service.BatchStepLogService;

/**
 * 레드마우스 고객인터페이스 주문,거래 전송 배치Scheduler Job Class
 ...
 * </pre>
 */
public class FmsCustSysInterfaceRedmouse1Tasklet implements Tasklet {

    @Resource(name = "/batch/fm/fms/fmsCustSysInterfaceRedmouse1DAO")
    private FmsCustSysInterfaceRedmouse1DAO fmsCustSysInterfaceRedmouse1DAO;
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        insertCount = fmsCustSysInterfaceRedmouse1DAO.batchJob(param);
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "FmsCustSysInterfaceRedmouse1Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "FmsCustSysInterfaceRedmouse1Step", "OK", strRtnMsg);
