...
import com.hwfs.batch.fm.fms.dao.FmsCustSysInterfaceSubinv1DAO;
 ...
 * </pre>
 */
public class FmsCustSysInterfaceSubinv1Tasklet implements Tasklet {

    @Resource(name = "/batch/fm/fms/fmsCustSysInterfaceSubinv1DAO")
    private FmsCustSysInterfaceSubinv1DAO fmsCustSysInterfaceSubinv1DAO;
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        insertCount = fmsCustSysInterfaceSubinv1DAO.batchJob(param);
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "FmsCustSysInterfaceSubinv1Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "FmsCustSysInterfaceSubinv1Step", "OK", strRtnMsg);
