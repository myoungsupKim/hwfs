 ...
 * </pre>
 */
public class AppMasterInterface37Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
        ...
        //System.out.println("AppMasterInterface37Tasklet stepExecutionId : " + stepExecutionId);
        ...
        param.put("FROM_UPJANG_CD", "179200");
        param.put("TO_UPJANG_CD", "179399");
        ...
        if (!LimsUtil.checkNull(retProcVal.get("PO_RTN")).equals("TRUE")) {
            ...
            batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface37Step", "FAILED", strRtnMsg);
        ...
        batchStepLogService.insertNewTx(stepExecutionId, "AppMasterInterface37Step", "OK", strRtnMsg);
