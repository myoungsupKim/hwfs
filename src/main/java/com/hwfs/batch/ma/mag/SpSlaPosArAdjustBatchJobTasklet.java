...
import com.hwfs.batch.ma.mag.dao.SpSlaPosArAdjustBatchJobProDAO;
 ...
 * </pre>
 */
public class SpSlaPosArAdjustBatchJobTasklet implements Tasklet {

	@Resource(name = "/batch/ma/mag/spSlaPosArAdjustBatchJobProDAO")
	private SpSlaPosArAdjustBatchJobProDAO spSlaPosArAdjustBatchJobProDAO;
	...
	public RepeatStatus execute(StepContribution step, ChunkContext chunkContext) throws Exception {
		...
		retProcVal = spSlaPosArAdjustBatchJobProDAO.spSlaPosArAdjustBatchJobPro(procParam);
		// 로그를 쌓는다.
