 ...
 *
 * @ClassName MapDayActjobPro2Dao.java
 * @Description MapDayActjobPro2Dao Class
 ...
 * </pre>
 */
@Repository("/batch/sc/map/MapDayActjobPro2DAO")
public class MapDayActjobPro2DAO extends DefaultBatchDAO {
     ...
     * @throws Exception
     */
    public Map<String, Object> mapDayactjobPro2(Map<String, Object> parameter) throws Exception {
        //전달 순서대로 설정
        ...
        String procedureName = "MAP_DAY_INFO_INSERT_PRO";
