...
import com.hwfs.ls.ltm.dao.TestResulTestArticleRegDAO;
import com.tobesoft.xplatform.data.DataSet;

/**
 * 시험결과등록-시험항목별 ServiceImple Class
 *
 * @ClassName TestResulTestArticleRegServiceImple.java
 * @Description TestResulTestArticleRegServiceImple Class
 ...
 * </pre>
 */
@Service("/ls/ltm/testResulTestArticleRegService")
public class TestResulTestArticleRegServiceImpl extends DefaultServiceImpl implements TestResulTestArticleRegService {

    @Resource(name = "/ls/ltm/testResulTestArticleRegDAO")
    private TestResulTestArticleRegDAO testResulTestArticleRegDAO;
     ...
     * @return
     * @throws Exception
     * @see com.hwfs.ls.ltm.service.TestResulTestArticleRegService#selectList(java.util.Map)
    */
    @Override
    public RecordSet selectList(Map<String, Object> parameter) throws Exception {
        return testResulTestArticleRegDAO.selectList(parameter);
    }
     ...
     * @return
     * @throws Exception
     * @see com.hwfs.ls.ltm.service.TestResulTestArticleRegService#selectDetailList(java.util.Map)
    */
    @Override
    public RecordSet selectDetailList(Map<String, Object> parameter) throws Exception {
        return testResulTestArticleRegDAO.selectDetailList(parameter);
    }
     ...
     * @return
     * @throws Exception
     * @see com.hwfs.ls.ltm.service.TestResulTestArticleRegService#saveList(java.util.Map, hone.online.xplatform.map.DataSetMap)
    */
    @Override
    ...
    public Map<String, Object> saveList(Map<String, Object> param, DataSetMap testArticleList) throws Exception {
        ...
        for (int i = 0; i < testArticleList.size(); i++) {
            ...
            if (rowType == DataSet.ROW_TYPE_UPDATED) {
                procCnt += testResulTestArticleRegDAO.updateTestArticleList(parameter);
            }
