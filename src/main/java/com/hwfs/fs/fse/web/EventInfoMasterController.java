...
import com.hwfs.fs.fse.service.EventInfoMasterService;
import com.hwfs.sc.cmn.dto.LoginDTO;


 /**
 * 기기/기물관리하는 EventInfoMaster Controller
 * 
 * @ClassName EventInfoMasterController.java
 * @Description EventInfoMasterController Class 
 ...
 */
@Controller
@RequestMapping("/fs/fse/eventInfoMaster/")
public class EventInfoMasterController extends DefaultController {
	
	/** LogService */
	//private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** EventInfoMasterService Bean 생성 */
	@Resource(name = "/fs/fse/eventInfoMasterService")
	private EventInfoMasterService eventInfoMasterService;
	...
	@RequestMapping("selectListCal.xdo")
	public ModelAndView selectListCal(
		...
		//마감현황 조회 을(를) 조회한다.
		RecordSet rs = eventInfoMasterService.selectListCal(inVar);
	...
	public ModelAndView selectComboLclass(
		...
		RecordSet rs = eventInfoMasterService.selectComboLclass(parameter, loginDTO);
	...
	public ModelAndView selectComboMclass(
		...
		RecordSet rs = eventInfoMasterService.selectComboMclass(parameter);
	...
	public ModelAndView selectComboSclass(
		...
		RecordSet rs = eventInfoMasterService.selectComboSclass(parameter);
	...
	public ModelAndView selectCodeUse(
		...
		Map<String, Object> parameter = param.get("ds_search").get(0);
		//System.out.println( "sclass_Search :"+param.get("ds_search").get(0));
		RecordSet rs = eventInfoMasterService.selectCodeUse(parameter);
	...
	public ModelAndView selectMachineMst(
		...
		RecordSet rs = eventInfoMasterService.selectMachineMst(parameter, loginDTO);
	...
	public ModelAndView selectList(
		...
		RecordSet rs = eventInfoMasterService.selectList(parameter);
	...
	public ModelAndView saveList(
		...
		int processCnt = eventInfoMasterService.saveList(parameterMachineMst, parameterGrd, loginDTO);
