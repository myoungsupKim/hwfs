...
import com.hwfs.fm.fms.dao.HubPriceInterfaceDAO;
 ...
 * </pre>
 */
@Service("/fm/fms/hubPriceInterfaceService")
public class HubPriceInterfaceServiceImpl extends DefaultServiceImpl implements HubPriceInterfaceService {
	
	/** LogService */
	private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** BatchJobMngtDAO Bean 생성 */
	@Resource(name = "/fm/fms/hubPriceInterfaceDAO")
	private HubPriceInterfaceDAO hubPriceInterfaceDAO;
	...
	public RecordSet selectPriceUpjang (Map<String, Object> mapParam) throws Exception {
		return hubPriceInterfaceDAO.selectPriceUpjang (mapParam);
	}
	...
	*/
	...
	public Map<String, Object> saveHubInterface(DataSetMap list) throws Exception {
		...
		/*	if (rowType == DataSet.ROW_TYPE_INSERTED ) {
			...
			//Update 처리
				...
				//rowStatus = "U";
				updRowCnt += hubPriceInterfaceDAO.updateHubInterface(rowData);
		/*	}
			//Delete 처리.
	...
	public int updateHubInterfaceManual(Map<String, Object> parameter) throws Exception{
		return hubPriceInterfaceDAO.updateHubInterfaceManual (parameter);
	}
	...
	public int saveHubInterfaceManual(Map<String, Object> parameter) throws Exception{
		return hubPriceInterfaceDAO.saveHubInterfaceManual (parameter);
	}
	...
	public RecordSet selectBatchAuth(Map<String, Object> mapParam) throws Exception {
		return hubPriceInterfaceDAO.selectBatchAuth(mapParam);
	}
