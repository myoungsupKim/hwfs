...
@Service
public class TestIFServiceImpl extends DefaultServiceImpl implements TestIFService {
	...
	*/
	...
	@CustomAnnotationDefinition(txId="IF_TEST",Description="인터페이스 TEST Service")
	public JSONObject selectList(JSONObject txHeader, JSONObject txData,JSONObject txResult) throws Exception {
		...
		} else if(txDiv.equals("SMS_MESSAGE_RESULT")){

			rs = externalPosMasterIFDAO.selectSmsResult(parameter);
