...
import com.tobesoft.xplatform.data.DataSet;
 ...
 /**
 * SlipDtlList에 대한 설명 작성
 * @ClassName SlipDtlList.java
 * @Description SlipDtlList Class
 ...
 * </pre>
 */
public class SlipDtlList implements EAIList {
	public List<SlipDtlDTO> dataList = new ArrayList<SlipDtlDTO>();
	...
	*/
	...
	public String getDeleteQueryId() {
		return "sc.cmn.sap.eaiListDAO.deleteSlipDtl";
	}
	...
	*/
	...
	public String getQueryId() {
		return "sc.cmn.sap.eaiListDAO.insertSlipDtl";
	}
	...
	*/
	...
	public void setDataList(RecordSet rs) {
		dataList = RecordUtils.convertToBeanList(rs, SlipDtlDTO.class);
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm) {
		for(int i = 0 ; i < dsm.getRowMaps().size() ; i++) {
			SlipDtlDTO dto = new SlipDtlDTO();
			dto = (SlipDtlDTO)DTOUtil.convertMapToVo(dsm.getRowMaps().get(i), dto);
			dataList.add(dto);
		}
	}
	...
	*/
	...
	public void setDataList(DataSetMap dsm, int rowType) {
		...
		for(int i = 0 ; i < maps.size() ; i++) {
			SlipDtlDTO dto = new SlipDtlDTO();
			dto = (SlipDtlDTO)DTOUtil.convertMapToVo(maps.get(i), dto);
			dataList.add(dto);
		}
	}
