...
import com.hwfs.sc.scz.service.AddrMgmtStCustService;


 /**
 * 거래처 주소를 검증하는 AddrMgmtStCust Controller
 * 
 * @ClassName AddrMgmtStCustController.java
 * @Description AddrMgmtStCustController Class 
 ...
 */
@Controller
@RequestMapping("/sc/scz/addrMgmtStCust/")
public class AddrMgmtStCustController extends DefaultController {
	
	/** LogService */
	private final Logger logger = LoggerFactory.getLogger (this.getClass());

	/** AddrMgmtStCustService Bean 생성 */
	@Resource(name = "/sc/scz/addrMgmtStCustService")
	private AddrMgmtStCustService addrMgmtStCustService;
	...
	public ModelAndView selectList(
		...
		//거래처 주소 을(를) 조회한다.
		RecordSet rs = addrMgmtStCustService.selectList(inVar);
	...
	/**
	 * 거래처 주소(을)를 Insert/Update/Delete 처리한다.
	 * <pre>
	 * - 메소드 상세설명 작성(생략 가능)-->생략 시 이 부분 삭제할 것
	 * </pre>
	 *
	...
	public ModelAndView saveList(
		...
		//거래처 주소을(를) 등록, 수정, 삭제 처리한다.
		int processCnt = addrMgmtStCustService.saveList(parameter);
